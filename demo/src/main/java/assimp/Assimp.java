...
{private Assimp() {}
    ...
    public static final double AI_CONFIG_GLOBAL_SCALE_FACTOR_DEFAULT = 1.0;
    ...
    public static final double AI_DEBONE_THRESHOLD = 1.0;
    public static final String AI_DEFAULT_MATERIAL_NAME = "DefaultMaterial";
    public static final String AI_EMBEDDED_TEXNAME_PREFIX = "*";
    public static final int AI_FAILURE = -1;
    public static final int AI_FALSE = 0;
    public static final int AI_IMPORT_IFC_DEFAULT_CYLINDRICAL_TESSELLATION = 32;
    public static final double AI_IMPORT_IFC_DEFAULT_SMOOTHING_ANGLE = 10.0;
    public static final int AI_LMW_MAX_WEIGHTS = 4;
    public static final double AI_MATH_HALF_PI = 1.5707963267948966;
    public static final double AI_MATH_HALF_PI_F = 1.5707963705062866;
    public static final double AI_MATH_PI = 3.141592653589793;
    public static final double AI_MATH_PI_F = 3.1415927410125732;
    public static final double AI_MATH_TWO_PI = 6.283185307179586;
    public static final double AI_MATH_TWO_PI_F = 6.2831854820251465;
    public static final String AI_MATKEY_ANISOTROPY_FACTOR = "$mat.anisotropyFactor";
    public static final String AI_MATKEY_BASE_COLOR = "$clr.base";
    public static final int AI_MATKEY_BASE_COLOR_TEXTURE = 12;
    ...
    public static final int AI_MATKEY_CLEARCOAT_NORMAL_TEXTURE = 20;
    public static final String AI_MATKEY_CLEARCOAT_ROUGHNESS_FACTOR = "$mat.clearcoat.roughnessFactor";
    public static final int AI_MATKEY_CLEARCOAT_ROUGHNESS_TEXTURE = 20;
    public static final int AI_MATKEY_CLEARCOAT_TEXTURE = 20;
    ...
    public static final int AI_MATKEY_METALLIC_TEXTURE = 15;
    ...
    public static final int AI_MATKEY_ROUGHNESS_TEXTURE = 16;
    ...
    public static final int AI_MATKEY_SHEEN_COLOR_TEXTURE = 19;
    public static final String AI_MATKEY_SHEEN_ROUGHNESS_FACTOR = "$mat.sheen.roughnessFactor";
    public static final int AI_MATKEY_SHEEN_ROUGHNESS_TEXTURE = 19;
    ...
    public static final int AI_MATKEY_TRANSMISSION_TEXTURE = 21;
    ...
    public static final int AI_MATKEY_VOLUME_THICKNESS_TEXTURE = 21;
    ...
    public static final int AI_OUTOFMEMORY = -3;
    ...
    public static final int AI_SUCCESS = 0;
    public static final int AI_TEXTURE_TYPE_MAX = 21;
    ...
    public static final int DLS_DEBUGGER = 8;
    public static final int DLS_FILE = 1;
    public static final int DLS_STDERR = 4;
    public static final int DLS_STDOUT = 2;
    ...
    public static final int aiProcessPreset_TargetRealtime_MaxQuality = 3645131;
    ...
    public static final double ai_epsilon = 9.999999974752427E-7;
