...
public record aiVector2D(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static aiVector2D getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new aiVector2D(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
