...
public record aiScene(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__mRootNode = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mRootNode");
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumMaterials = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumMaterials");
    public static final long OFFSET__mNumMaterials = 32;
    public static final java.lang.foreign.AddressLayout LAYOUT__mMaterials = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mMaterials");
    public static final long OFFSET__mMaterials = 40;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumAnimations = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumAnimations");
    public static final long OFFSET__mNumAnimations = 48;
    public static final java.lang.foreign.AddressLayout LAYOUT__mAnimations = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mAnimations");
    public static final long OFFSET__mAnimations = 56;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumTextures = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumTextures");
    public static final long OFFSET__mNumTextures = 64;
    public static final java.lang.foreign.AddressLayout LAYOUT__mTextures = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mTextures");
    public static final long OFFSET__mTextures = 72;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumLights = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumLights");
    public static final long OFFSET__mNumLights = 80;
    public static final java.lang.foreign.AddressLayout LAYOUT__mLights = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mLights");
    public static final long OFFSET__mLights = 88;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumCameras = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumCameras");
    public static final long OFFSET__mNumCameras = 96;
    public static final java.lang.foreign.AddressLayout LAYOUT__mCameras = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mCameras");
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__mNumSkeletons = java.lang.foreign.ValueLayout.JAVA_INT.withName("mNumSkeletons");
    public static final long OFFSET__mNumSkeletons = 1148;
    public static final java.lang.foreign.AddressLayout LAYOUT__mSkeletons = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mSkeletons");
    public static final long OFFSET__mSkeletons = 1152;
    public static final java.lang.foreign.AddressLayout LAYOUT__mPrivate = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("mPrivate");
