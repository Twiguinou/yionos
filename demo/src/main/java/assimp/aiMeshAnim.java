...
public record aiMeshAnim(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static aiMeshAnim getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new aiMeshAnim(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
