...
public record aiMeshAnim(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__mNumKeys,
            LAYOUT__mKeys
    ).withByteAlignment(8).withName("aiMeshAnim");

    public aiMeshAnim(java.lang.foreign.SegmentAllocator allocator)
    {
        this(allocator.allocate(gRecordLayout));
    }

    public static aiMeshAnim getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new aiMeshAnim(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, aiMeshAnim value)
    {
