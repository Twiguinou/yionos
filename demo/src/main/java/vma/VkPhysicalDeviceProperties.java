...
public record VkPhysicalDeviceProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__limits = vma.VkPhysicalDeviceLimits.gRecordLayout.withName("limits");
    public static final long OFFSET__limits = 296;
    public static final java.lang.foreign.StructLayout LAYOUT__sparseProperties = vma.VkPhysicalDeviceSparseProperties.gRecordLayout.withName("sparseProperties");
    ...
    public vma.VkPhysicalDeviceLimits limits() {return new vma.VkPhysicalDeviceLimits(this.ptr.asSlice(OFFSET__limits, LAYOUT__limits));}
    public void limits(java.util.function.Consumer<vma.VkPhysicalDeviceLimits> consumer) {consumer.accept(this.limits());}
    public void limits(vma.VkPhysicalDeviceLimits value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET__limits, LAYOUT__limits.byteSize());}

    public vma.VkPhysicalDeviceSparseProperties sparseProperties() {return new vma.VkPhysicalDeviceSparseProperties(this.ptr.asSlice(OFFSET__sparseProperties, LAYOUT__sparseProperties));}
    public void sparseProperties(java.util.function.Consumer<vma.VkPhysicalDeviceSparseProperties> consumer) {consumer.accept(this.sparseProperties());}
    public void sparseProperties(vma.VkPhysicalDeviceSparseProperties value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET__sparseProperties, LAYOUT__sparseProperties.byteSize());}
}
