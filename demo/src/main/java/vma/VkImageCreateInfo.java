...
public record VkImageCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__extent = vma.VkExtent3D.gRecordLayout.withName("extent");
    ...
    public vma.VkExtent3D extent() {return new vma.VkExtent3D(this.ptr.asSlice(OFFSET__extent, LAYOUT__extent));}
    public void extent(java.util.function.Consumer<vma.VkExtent3D> consumer) {consumer.accept(this.extent());}
    public void extent(vma.VkExtent3D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET__extent, LAYOUT__extent.byteSize());}
