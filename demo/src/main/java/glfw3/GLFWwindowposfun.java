...
public interface GLFWwindowposfun
{
    ...
    java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", GLFWwindowposfun.class);

    void invoke(java.lang.foreign.MemorySegment window, int xpos, int ypos);
