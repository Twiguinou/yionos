...
public interface GLFWcharfun
{
    ...
    java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", GLFWcharfun.class);

    void invoke(java.lang.foreign.MemorySegment window, int codepoint);
