...
public record VkPerformanceCounterDescriptionKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPerformanceCounterDescriptionKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPerformanceCounterDescriptionKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
