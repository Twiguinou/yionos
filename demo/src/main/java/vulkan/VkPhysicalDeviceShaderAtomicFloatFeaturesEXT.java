...
public record VkPhysicalDeviceShaderAtomicFloatFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderAtomicFloatFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderAtomicFloatFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
