...
public record VkRenderingInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderingInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderingInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
