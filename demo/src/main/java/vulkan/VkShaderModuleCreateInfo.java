...
public record VkShaderModuleCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkShaderModuleCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkShaderModuleCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
