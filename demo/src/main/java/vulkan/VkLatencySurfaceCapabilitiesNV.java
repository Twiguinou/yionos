...
public record VkLatencySurfaceCapabilitiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkLatencySurfaceCapabilitiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkLatencySurfaceCapabilitiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
