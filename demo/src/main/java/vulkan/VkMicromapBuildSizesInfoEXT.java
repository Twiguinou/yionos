...
public record VkMicromapBuildSizesInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMicromapBuildSizesInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMicromapBuildSizesInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
