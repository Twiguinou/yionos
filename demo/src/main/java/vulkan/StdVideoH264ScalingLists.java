...
public record StdVideoH264ScalingLists(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH264ScalingLists getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH264ScalingLists(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
