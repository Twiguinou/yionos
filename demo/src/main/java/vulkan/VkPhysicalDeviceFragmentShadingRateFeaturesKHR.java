...
public record VkPhysicalDeviceFragmentShadingRateFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFragmentShadingRateFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFragmentShadingRateFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
