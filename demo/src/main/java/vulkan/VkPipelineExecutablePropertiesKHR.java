...
public record VkPipelineExecutablePropertiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineExecutablePropertiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineExecutablePropertiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
