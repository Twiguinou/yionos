...
public record VkPhysicalDeviceTimelineSemaphoreProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTimelineSemaphoreProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTimelineSemaphoreProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
