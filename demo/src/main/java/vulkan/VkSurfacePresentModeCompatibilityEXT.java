...
public record VkSurfacePresentModeCompatibilityEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    ).withByteAlignment(8).withName("VkSurfacePresentModeCompatibilityEXT");
    ...
    public static VkSurfacePresentModeCompatibilityEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkSurfacePresentModeCompatibilityEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkSurfacePresentModeCompatibilityEXT value)
    {
