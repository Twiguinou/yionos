...
public record VkSurfacePresentModeCompatibilityEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSurfacePresentModeCompatibilityEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSurfacePresentModeCompatibilityEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
