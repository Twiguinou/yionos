...
public record VkVideoEncodeH264SessionParametersAddInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoEncodeH264SessionParametersAddInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoEncodeH264SessionParametersAddInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
