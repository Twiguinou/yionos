...
public record VkCudaLaunchInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCudaLaunchInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCudaLaunchInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
