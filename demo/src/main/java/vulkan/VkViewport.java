...
public record VkViewport(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkViewport getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkViewport(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
