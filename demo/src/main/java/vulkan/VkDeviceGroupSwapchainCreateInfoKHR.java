...
public record VkDeviceGroupSwapchainCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceGroupSwapchainCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceGroupSwapchainCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
