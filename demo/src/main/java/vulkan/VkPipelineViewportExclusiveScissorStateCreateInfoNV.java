...
public record VkPipelineViewportExclusiveScissorStateCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineViewportExclusiveScissorStateCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineViewportExclusiveScissorStateCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
