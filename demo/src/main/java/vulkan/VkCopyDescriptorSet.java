...
public record VkCopyDescriptorSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyDescriptorSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyDescriptorSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
