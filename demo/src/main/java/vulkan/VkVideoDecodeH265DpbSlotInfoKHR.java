...
public record VkVideoDecodeH265DpbSlotInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH265DpbSlotInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH265DpbSlotInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
