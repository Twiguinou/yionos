...
public record VkDescriptorPoolSize(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorPoolSize getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorPoolSize(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
