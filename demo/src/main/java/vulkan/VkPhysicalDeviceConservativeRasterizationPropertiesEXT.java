...
public record VkPhysicalDeviceConservativeRasterizationPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceConservativeRasterizationPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceConservativeRasterizationPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
