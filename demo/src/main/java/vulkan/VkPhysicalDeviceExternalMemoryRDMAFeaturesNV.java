...
public record VkPhysicalDeviceExternalMemoryRDMAFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceExternalMemoryRDMAFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceExternalMemoryRDMAFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
