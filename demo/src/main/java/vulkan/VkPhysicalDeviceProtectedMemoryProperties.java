...
public record VkPhysicalDeviceProtectedMemoryProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceProtectedMemoryProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceProtectedMemoryProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
