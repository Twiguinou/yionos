...
public record VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
