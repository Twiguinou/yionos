...
public record VkDeviceGroupRenderPassBeginInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceGroupRenderPassBeginInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceGroupRenderPassBeginInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
