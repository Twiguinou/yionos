...
public record VkBufferMemoryRequirementsInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferMemoryRequirementsInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferMemoryRequirementsInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
