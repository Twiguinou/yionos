...
public record VkPhysicalDeviceTextureCompressionASTCHDRFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTextureCompressionASTCHDRFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTextureCompressionASTCHDRFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
