...
public record VkDisplayPowerInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDisplayPowerInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDisplayPowerInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
