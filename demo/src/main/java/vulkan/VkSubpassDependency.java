...
public record VkSubpassDependency(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubpassDependency getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubpassDependency(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
