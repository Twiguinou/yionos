...
public record VkLatencySubmissionPresentIdNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkLatencySubmissionPresentIdNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkLatencySubmissionPresentIdNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
