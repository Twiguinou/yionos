...
public record VkAttachmentReference(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAttachmentReference getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAttachmentReference(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
