...
public record VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
