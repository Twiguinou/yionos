...
public record VkDebugMarkerObjectNameInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDebugMarkerObjectNameInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDebugMarkerObjectNameInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
