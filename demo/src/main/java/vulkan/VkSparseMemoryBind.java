...
public record VkSparseMemoryBind(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSparseMemoryBind getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSparseMemoryBind(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
