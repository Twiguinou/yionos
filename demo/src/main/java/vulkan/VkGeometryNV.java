...
public record VkGeometryNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGeometryNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGeometryNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void geometry(vulkan.VkGeometryDataNV value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$geometry, LAYOUT$geometry.byteSize());}
