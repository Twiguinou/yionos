...
public record VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
