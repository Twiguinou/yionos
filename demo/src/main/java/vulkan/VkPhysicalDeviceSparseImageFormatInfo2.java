...
public record VkPhysicalDeviceSparseImageFormatInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceSparseImageFormatInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceSparseImageFormatInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
