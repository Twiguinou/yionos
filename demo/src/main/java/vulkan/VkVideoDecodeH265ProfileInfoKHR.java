...
public record VkVideoDecodeH265ProfileInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH265ProfileInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH265ProfileInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
