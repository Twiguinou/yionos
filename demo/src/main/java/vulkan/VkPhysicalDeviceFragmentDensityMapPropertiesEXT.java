...
public record VkPhysicalDeviceFragmentDensityMapPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFragmentDensityMapPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFragmentDensityMapPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void minFragmentDensityTexelSize(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$minFragmentDensityTexelSize, LAYOUT$minFragmentDensityTexelSize.byteSize());}
    ...
    public void maxFragmentDensityTexelSize(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$maxFragmentDensityTexelSize, LAYOUT$maxFragmentDensityTexelSize.byteSize());}
