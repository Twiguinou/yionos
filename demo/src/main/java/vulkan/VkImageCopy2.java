...
public record VkImageCopy2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageCopy2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageCopy2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
