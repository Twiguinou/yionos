...
public record VkDisplayPresentInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDisplayPresentInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDisplayPresentInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void srcRect(vulkan.VkRect2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$srcRect, LAYOUT$srcRect.byteSize());}
    ...
    public void dstRect(vulkan.VkRect2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$dstRect, LAYOUT$dstRect.byteSize());}
