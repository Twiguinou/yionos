...
public record VkRenderPassCreationFeedbackInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassCreationFeedbackInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassCreationFeedbackInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
