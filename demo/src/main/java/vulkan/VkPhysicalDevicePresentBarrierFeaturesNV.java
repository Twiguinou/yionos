...
public record VkPhysicalDevicePresentBarrierFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePresentBarrierFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePresentBarrierFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
