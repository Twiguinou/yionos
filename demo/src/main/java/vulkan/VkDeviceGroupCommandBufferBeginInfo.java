...
public record VkDeviceGroupCommandBufferBeginInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceGroupCommandBufferBeginInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceGroupCommandBufferBeginInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
