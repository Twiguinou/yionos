...
public record VkRenderPassCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    ).withByteAlignment(8).withName("VkRenderPassCreateInfo");
    ...
    public static VkRenderPassCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkRenderPassCreateInfo(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkRenderPassCreateInfo value)
    {
