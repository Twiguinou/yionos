...
public record VkRenderPassCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
