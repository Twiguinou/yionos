...
public record VkDrawIndexedIndirectCommand(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrawIndexedIndirectCommand getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrawIndexedIndirectCommand(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
