...
public record VkPhysicalDeviceToolProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceToolProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceToolProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
