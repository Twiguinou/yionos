...
public record VkPipelineShaderStageModuleIdentifierCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineShaderStageModuleIdentifierCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineShaderStageModuleIdentifierCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
