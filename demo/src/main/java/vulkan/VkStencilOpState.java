...
public record VkStencilOpState(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkStencilOpState getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkStencilOpState(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
