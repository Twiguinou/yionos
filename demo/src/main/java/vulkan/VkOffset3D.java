...
public record VkOffset3D(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkOffset3D getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkOffset3D(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
