...
public record VkPhysicalDeviceCoverageReductionModeFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCoverageReductionModeFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCoverageReductionModeFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
