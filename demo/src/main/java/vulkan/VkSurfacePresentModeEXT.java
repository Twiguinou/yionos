...
public record VkSurfacePresentModeEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSurfacePresentModeEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSurfacePresentModeEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
