...
public record VkPhysicalDeviceProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void limits(vulkan.VkPhysicalDeviceLimits value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$limits, LAYOUT$limits.byteSize());}
    ...
    public void sparseProperties(vulkan.VkPhysicalDeviceSparseProperties value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$sparseProperties, LAYOUT$sparseProperties.byteSize());}
}
