...
public record VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
