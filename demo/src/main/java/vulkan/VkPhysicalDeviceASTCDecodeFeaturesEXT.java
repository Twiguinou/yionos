...
public record VkPhysicalDeviceASTCDecodeFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceASTCDecodeFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceASTCDecodeFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
