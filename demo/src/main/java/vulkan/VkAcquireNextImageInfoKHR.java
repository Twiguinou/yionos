...
public record VkAcquireNextImageInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAcquireNextImageInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAcquireNextImageInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
