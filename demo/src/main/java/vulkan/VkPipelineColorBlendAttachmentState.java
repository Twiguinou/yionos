...
public record VkPipelineColorBlendAttachmentState(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineColorBlendAttachmentState getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineColorBlendAttachmentState(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
