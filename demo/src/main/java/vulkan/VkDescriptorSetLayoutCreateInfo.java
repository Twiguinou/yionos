...
public record VkDescriptorSetLayoutCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorSetLayoutCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorSetLayoutCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
