...
public record VkMemoryRequirements(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryRequirements getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryRequirements(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
