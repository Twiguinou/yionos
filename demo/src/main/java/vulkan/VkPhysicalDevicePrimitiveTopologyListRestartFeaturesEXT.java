...
public record VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
