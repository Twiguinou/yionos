...
public record VkRenderPassTransformBeginInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassTransformBeginInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassTransformBeginInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
