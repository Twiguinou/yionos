...
public record VkStridedDeviceAddressRegionKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkStridedDeviceAddressRegionKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkStridedDeviceAddressRegionKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
