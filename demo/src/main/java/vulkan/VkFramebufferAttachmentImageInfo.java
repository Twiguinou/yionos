...
public record VkFramebufferAttachmentImageInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkFramebufferAttachmentImageInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkFramebufferAttachmentImageInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
