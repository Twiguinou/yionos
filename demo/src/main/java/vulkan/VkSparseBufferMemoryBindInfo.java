...
public record VkSparseBufferMemoryBindInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSparseBufferMemoryBindInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSparseBufferMemoryBindInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
