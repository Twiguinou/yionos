...
public record VkPhysicalDeviceMeshShaderFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceMeshShaderFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceMeshShaderFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
