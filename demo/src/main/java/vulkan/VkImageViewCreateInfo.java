...
public record VkImageViewCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageViewCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageViewCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
