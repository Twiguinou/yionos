...
public record VkMemoryRequirements2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryRequirements2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryRequirements2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
