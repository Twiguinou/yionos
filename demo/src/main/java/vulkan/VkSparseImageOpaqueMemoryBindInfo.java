...
public record VkSparseImageOpaqueMemoryBindInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSparseImageOpaqueMemoryBindInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSparseImageOpaqueMemoryBindInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
