...
public record VkMemoryGetRemoteAddressInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__handleType,
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkMemoryGetRemoteAddressInfoNV");
    ...
    public static VkMemoryGetRemoteAddressInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkMemoryGetRemoteAddressInfoNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkMemoryGetRemoteAddressInfoNV value)
    {
