...
public record VkMemoryGetRemoteAddressInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryGetRemoteAddressInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryGetRemoteAddressInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
