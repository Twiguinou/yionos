...
public record VkResolveImageInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__regionCount,
            LAYOUT__pRegions
    ).withByteAlignment(8).withName("VkResolveImageInfo2");
    ...
    public static VkResolveImageInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkResolveImageInfo2(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkResolveImageInfo2 value)
    {
