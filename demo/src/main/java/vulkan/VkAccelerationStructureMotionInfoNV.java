...
public record VkAccelerationStructureMotionInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureMotionInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureMotionInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
