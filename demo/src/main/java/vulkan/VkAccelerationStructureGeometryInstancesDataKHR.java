...
public record VkAccelerationStructureGeometryInstancesDataKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureGeometryInstancesDataKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureGeometryInstancesDataKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
