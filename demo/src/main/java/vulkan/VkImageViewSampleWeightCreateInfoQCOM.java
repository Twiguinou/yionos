...
public record VkImageViewSampleWeightCreateInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageViewSampleWeightCreateInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageViewSampleWeightCreateInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void filterCenter(vulkan.VkOffset2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$filterCenter, LAYOUT$filterCenter.byteSize());}
    ...
    public void filterSize(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$filterSize, LAYOUT$filterSize.byteSize());}
