...
public record VkPhysicalDeviceCustomBorderColorFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCustomBorderColorFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCustomBorderColorFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
