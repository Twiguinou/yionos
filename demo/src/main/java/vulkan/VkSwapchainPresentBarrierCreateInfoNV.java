...
public record VkSwapchainPresentBarrierCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSwapchainPresentBarrierCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSwapchainPresentBarrierCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
