...
public record VkConformanceVersion(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkConformanceVersion getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkConformanceVersion(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
