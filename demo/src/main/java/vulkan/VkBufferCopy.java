...
public record VkBufferCopy(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferCopy getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferCopy(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
