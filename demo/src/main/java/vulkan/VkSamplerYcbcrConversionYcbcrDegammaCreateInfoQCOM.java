...
public record VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
