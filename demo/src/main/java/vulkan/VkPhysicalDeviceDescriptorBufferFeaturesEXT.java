...
public record VkPhysicalDeviceDescriptorBufferFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDescriptorBufferFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDescriptorBufferFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
