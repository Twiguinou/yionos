...
public record VkSubpassDescription(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubpassDescription getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubpassDescription(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
