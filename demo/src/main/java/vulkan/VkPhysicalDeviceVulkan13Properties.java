...
public record VkPhysicalDeviceVulkan13Properties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceVulkan13Properties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceVulkan13Properties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
