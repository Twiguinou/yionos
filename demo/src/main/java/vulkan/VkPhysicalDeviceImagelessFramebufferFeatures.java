...
public record VkPhysicalDeviceImagelessFramebufferFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImagelessFramebufferFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImagelessFramebufferFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
