...
public record VkDeviceFaultCountsEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceFaultCountsEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceFaultCountsEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
