...
public record VkDescriptorPoolCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorPoolCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorPoolCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
