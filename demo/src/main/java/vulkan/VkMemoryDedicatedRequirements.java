...
public record VkMemoryDedicatedRequirements(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryDedicatedRequirements getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryDedicatedRequirements(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
