...
public record VkDedicatedAllocationMemoryAllocateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDedicatedAllocationMemoryAllocateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDedicatedAllocationMemoryAllocateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
