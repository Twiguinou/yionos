...
public record VkDedicatedAllocationMemoryAllocateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__image,
            LAYOUT__buffer
    ).withByteAlignment(8).withName("VkDedicatedAllocationMemoryAllocateInfoNV");
    ...
    public static VkDedicatedAllocationMemoryAllocateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkDedicatedAllocationMemoryAllocateInfoNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkDedicatedAllocationMemoryAllocateInfoNV value)
    {
