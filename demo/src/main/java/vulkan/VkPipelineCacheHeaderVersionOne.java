...
public record VkPipelineCacheHeaderVersionOne(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineCacheHeaderVersionOne getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineCacheHeaderVersionOne(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
