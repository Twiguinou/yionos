...
public record VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
