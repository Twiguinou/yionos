...
public record VkBufferImageCopy2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferImageCopy2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferImageCopy2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
