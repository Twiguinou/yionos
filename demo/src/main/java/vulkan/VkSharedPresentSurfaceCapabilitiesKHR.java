...
public record VkSharedPresentSurfaceCapabilitiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSharedPresentSurfaceCapabilitiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSharedPresentSurfaceCapabilitiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
