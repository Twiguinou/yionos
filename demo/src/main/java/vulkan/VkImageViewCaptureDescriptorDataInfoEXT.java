...
public record VkImageViewCaptureDescriptorDataInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageViewCaptureDescriptorDataInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageViewCaptureDescriptorDataInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
