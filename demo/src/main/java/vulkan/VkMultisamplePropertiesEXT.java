...
public record VkMultisamplePropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMultisamplePropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMultisamplePropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
