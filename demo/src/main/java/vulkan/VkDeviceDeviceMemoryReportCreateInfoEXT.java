...
public record VkDeviceDeviceMemoryReportCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceDeviceMemoryReportCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceDeviceMemoryReportCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
