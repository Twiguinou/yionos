...
public record VkVertexInputAttributeDescription(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVertexInputAttributeDescription getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVertexInputAttributeDescription(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
