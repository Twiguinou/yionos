...
public record VkRayTracingPipelineCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRayTracingPipelineCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRayTracingPipelineCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
