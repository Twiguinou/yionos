...
public record VkGeneratedCommandsInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGeneratedCommandsInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGeneratedCommandsInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
