...
public record VkPhysicalDeviceTransformFeedbackPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTransformFeedbackPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTransformFeedbackPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
