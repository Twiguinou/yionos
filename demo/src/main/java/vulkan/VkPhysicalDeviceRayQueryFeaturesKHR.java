...
public record VkPhysicalDeviceRayQueryFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayQueryFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayQueryFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
