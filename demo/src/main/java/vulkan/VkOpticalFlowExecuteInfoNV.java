...
public record VkOpticalFlowExecuteInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__regionCount,
            LAYOUT__pRegions
    ).withByteAlignment(8).withName("VkOpticalFlowExecuteInfoNV");
    ...
    public static VkOpticalFlowExecuteInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkOpticalFlowExecuteInfoNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkOpticalFlowExecuteInfoNV value)
    {
