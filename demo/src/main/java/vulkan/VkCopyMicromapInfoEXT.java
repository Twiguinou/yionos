...
public record VkCopyMicromapInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyMicromapInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyMicromapInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
