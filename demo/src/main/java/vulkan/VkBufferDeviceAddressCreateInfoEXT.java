...
public record VkBufferDeviceAddressCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferDeviceAddressCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferDeviceAddressCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
