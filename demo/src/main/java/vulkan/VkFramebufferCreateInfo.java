...
public record VkFramebufferCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkFramebufferCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkFramebufferCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
