...
public record VkPerformanceCounterResultKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPerformanceCounterResultKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPerformanceCounterResultKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
