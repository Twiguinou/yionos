...
public record VkRenderingInputAttachmentIndexInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pColorAttachmentInputIndices = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pColorAttachmentInputIndices");
    public static final long OFFSET__pColorAttachmentInputIndices = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__pDepthInputAttachmentIndex = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pDepthInputAttachmentIndex");
    public static final long OFFSET__pDepthInputAttachmentIndex = 32;
    public static final java.lang.foreign.AddressLayout LAYOUT__pStencilInputAttachmentIndex = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pStencilInputAttachmentIndex");
