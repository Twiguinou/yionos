...
public record VkAccelerationStructureTrianglesOpacityMicromapEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureTrianglesOpacityMicromapEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureTrianglesOpacityMicromapEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void indexBuffer(vulkan.VkDeviceOrHostAddressConstKHR value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$indexBuffer, LAYOUT$indexBuffer.byteSize());}
