...
public record VkPipelineCreationFeedbackCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pPipelineCreationFeedback = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pPipelineCreationFeedback");
    public static final long OFFSET__pPipelineCreationFeedback = 16;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__pipelineStageCreationFeedbackCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("pipelineStageCreationFeedbackCount");
    public static final long OFFSET__pipelineStageCreationFeedbackCount = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__pPipelineStageCreationFeedbacks = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pPipelineStageCreationFeedbacks");
