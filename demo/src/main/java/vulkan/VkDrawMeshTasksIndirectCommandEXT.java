...
public record VkDrawMeshTasksIndirectCommandEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrawMeshTasksIndirectCommandEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrawMeshTasksIndirectCommandEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
