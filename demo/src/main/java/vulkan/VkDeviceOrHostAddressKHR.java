...
public record VkDeviceOrHostAddressKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceOrHostAddressKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceOrHostAddressKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
