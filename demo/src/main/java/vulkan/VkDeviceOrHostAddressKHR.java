...
public record VkDeviceOrHostAddressKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.UnionLayout gRecordLayout = java.lang.foreign.MemoryLayout.unionLayout(
            ...
            LAYOUT__hostAddress
    ).withByteAlignment(8).withName("VkDeviceOrHostAddressKHR");
    ...
    public static VkDeviceOrHostAddressKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkDeviceOrHostAddressKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkDeviceOrHostAddressKHR value)
    {
