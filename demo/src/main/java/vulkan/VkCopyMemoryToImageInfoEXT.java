...
public record VkCopyMemoryToImageInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyMemoryToImageInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyMemoryToImageInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
