...
public record VkCopyMemoryToImageInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__regionCount,
            LAYOUT__pRegions
    ).withByteAlignment(8).withName("VkCopyMemoryToImageInfoEXT");
    ...
    public static VkCopyMemoryToImageInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkCopyMemoryToImageInfoEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkCopyMemoryToImageInfoEXT value)
    {
