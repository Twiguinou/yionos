...
public record VkPhysicalDeviceShaderSMBuiltinsFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderSMBuiltinsFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderSMBuiltinsFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
