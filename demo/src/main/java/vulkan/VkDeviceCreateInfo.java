...
public record VkDeviceCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
