...
public record VkAccelerationStructureDeviceAddressInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureDeviceAddressInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureDeviceAddressInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
