...
public record VkVideoDecodeH264ProfileInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH264ProfileInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH264ProfileInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
