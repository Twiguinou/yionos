...
public record VkCheckpointDataNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pCheckpointMarker = jpgen.NativeTypes.UNBOUNDED_POINTER;
    ...
    ).withByteAlignment(8).withName("VkCheckpointDataNV");
    ...
    public static VkCheckpointDataNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkCheckpointDataNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkCheckpointDataNV value)
    {
