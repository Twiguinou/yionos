...
public record VkCheckpointDataNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCheckpointDataNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCheckpointDataNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
