...
public record VkDisplayModeCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long OFFSET__parameters = 20;
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__flags,
            LAYOUT__parameters
    ).withByteAlignment(8).withName("VkDisplayModeCreateInfoKHR");
    ...
    public static VkDisplayModeCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkDisplayModeCreateInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkDisplayModeCreateInfoKHR value)
    {
