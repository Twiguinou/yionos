...
public record VkPhysicalDeviceShaderAtomicInt64Features(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderAtomicInt64Features getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderAtomicInt64Features(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
