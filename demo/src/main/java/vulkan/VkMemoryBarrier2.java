...
public record VkMemoryBarrier2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryBarrier2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryBarrier2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
