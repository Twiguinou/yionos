...
public record VkPhysicalDeviceImageViewImageFormatInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImageViewImageFormatInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImageViewImageFormatInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
