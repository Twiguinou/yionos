...
public record VkPhysicalDeviceShaderIntegerDotProductProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderIntegerDotProductProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderIntegerDotProductProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
