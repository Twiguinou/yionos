...
public record VkImagePlaneMemoryRequirementsInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImagePlaneMemoryRequirementsInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImagePlaneMemoryRequirementsInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
