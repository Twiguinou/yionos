...
public record VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
