...
public record VkPhysicalDeviceDriverProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDriverProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDriverProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
