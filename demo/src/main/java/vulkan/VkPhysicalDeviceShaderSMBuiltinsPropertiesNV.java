...
public record VkPhysicalDeviceShaderSMBuiltinsPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderSMBuiltinsPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderSMBuiltinsPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
