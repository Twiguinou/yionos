...
public record VkBindImagePlaneMemoryInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__planeAspect,
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkBindImagePlaneMemoryInfo");
    ...
    public static VkBindImagePlaneMemoryInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkBindImagePlaneMemoryInfo(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkBindImagePlaneMemoryInfo value)
    {
