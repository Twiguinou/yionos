...
public record VkImageSubresource(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageSubresource getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageSubresource(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
