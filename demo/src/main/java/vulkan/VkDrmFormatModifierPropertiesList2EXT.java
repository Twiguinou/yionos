...
public record VkDrmFormatModifierPropertiesList2EXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrmFormatModifierPropertiesList2EXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrmFormatModifierPropertiesList2EXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
