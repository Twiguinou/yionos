...
public record VkDrmFormatModifierPropertiesList2EXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pDrmFormatModifierProperties = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pDrmFormatModifierProperties");
    ...
    ).withByteAlignment(8).withName("VkDrmFormatModifierPropertiesList2EXT");
    ...
    public static VkDrmFormatModifierPropertiesList2EXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkDrmFormatModifierPropertiesList2EXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkDrmFormatModifierPropertiesList2EXT value)
    {
