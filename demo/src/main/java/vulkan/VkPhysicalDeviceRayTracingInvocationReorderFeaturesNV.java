...
public record VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingInvocationReorderFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
