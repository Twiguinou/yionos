...
public record VkDescriptorBufferBindingPushDescriptorBufferHandleEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorBufferBindingPushDescriptorBufferHandleEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorBufferBindingPushDescriptorBufferHandleEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
