...
public record VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
