...
public record VkDescriptorSetBindingReferenceVALVE(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorSetBindingReferenceVALVE getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorSetBindingReferenceVALVE(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
