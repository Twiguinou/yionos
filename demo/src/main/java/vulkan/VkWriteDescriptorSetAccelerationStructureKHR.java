...
public record VkWriteDescriptorSetAccelerationStructureKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkWriteDescriptorSetAccelerationStructureKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkWriteDescriptorSetAccelerationStructureKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
