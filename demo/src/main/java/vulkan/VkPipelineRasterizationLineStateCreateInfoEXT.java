...
public record VkPipelineRasterizationLineStateCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineRasterizationLineStateCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineRasterizationLineStateCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
