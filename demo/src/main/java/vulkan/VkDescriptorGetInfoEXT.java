...
public record VkDescriptorGetInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorGetInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorGetInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void data(vulkan.VkDescriptorDataEXT value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$data, LAYOUT$data.byteSize());}
}
