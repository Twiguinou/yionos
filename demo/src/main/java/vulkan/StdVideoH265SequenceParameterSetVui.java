...
public record StdVideoH265SequenceParameterSetVui(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265SequenceParameterSetVui getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265SequenceParameterSetVui(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH265SpsVuiFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
