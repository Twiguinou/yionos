...
public record VkComputePipelineCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkComputePipelineCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkComputePipelineCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void stage(vulkan.VkPipelineShaderStageCreateInfo value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$stage, LAYOUT$stage.byteSize());}
