...
public record VkSetStateFlagsIndirectCommandNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSetStateFlagsIndirectCommandNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSetStateFlagsIndirectCommandNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
