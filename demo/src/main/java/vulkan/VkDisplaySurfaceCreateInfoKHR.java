...
public record VkDisplaySurfaceCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDisplaySurfaceCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDisplaySurfaceCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
