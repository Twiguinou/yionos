...
public record VkPhysicalDeviceIndexTypeUint8FeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceIndexTypeUint8FeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceIndexTypeUint8FeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
