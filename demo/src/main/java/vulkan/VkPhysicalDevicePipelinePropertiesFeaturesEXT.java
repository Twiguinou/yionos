...
public record VkPhysicalDevicePipelinePropertiesFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePipelinePropertiesFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePipelinePropertiesFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
