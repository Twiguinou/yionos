...
public record VkDirectDriverLoadingListLUNARG(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDirectDriverLoadingListLUNARG getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDirectDriverLoadingListLUNARG(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
