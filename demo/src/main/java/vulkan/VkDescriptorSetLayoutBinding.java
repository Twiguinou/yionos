...
public record VkDescriptorSetLayoutBinding(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorSetLayoutBinding getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorSetLayoutBinding(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
