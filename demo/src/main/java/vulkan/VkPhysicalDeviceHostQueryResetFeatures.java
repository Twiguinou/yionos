...
public record VkPhysicalDeviceHostQueryResetFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceHostQueryResetFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceHostQueryResetFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
