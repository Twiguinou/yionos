...
public record VkPhysicalDeviceBufferDeviceAddressFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceBufferDeviceAddressFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceBufferDeviceAddressFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
