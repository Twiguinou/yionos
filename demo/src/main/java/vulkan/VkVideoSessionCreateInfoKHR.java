...
public record VkVideoSessionCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoSessionCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoSessionCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
