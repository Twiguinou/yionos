...
public record VkAccelerationStructureGeometryMotionTrianglesDataNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__pNext,
            LAYOUT__vertexData
    ).withByteAlignment(8).withName("VkAccelerationStructureGeometryMotionTrianglesDataNV");
    ...
    public static VkAccelerationStructureGeometryMotionTrianglesDataNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkAccelerationStructureGeometryMotionTrianglesDataNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkAccelerationStructureGeometryMotionTrianglesDataNV value)
    {
