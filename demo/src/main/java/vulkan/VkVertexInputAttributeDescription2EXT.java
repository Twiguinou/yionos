...
public record VkVertexInputAttributeDescription2EXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVertexInputAttributeDescription2EXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVertexInputAttributeDescription2EXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
