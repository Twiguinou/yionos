...
public record VkSamplerReductionModeCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSamplerReductionModeCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSamplerReductionModeCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
