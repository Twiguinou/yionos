...
public record VkSparseImageFormatProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSparseImageFormatProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSparseImageFormatProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void imageGranularity(vulkan.VkExtent3D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$imageGranularity, LAYOUT$imageGranularity.byteSize());}
