...
public record VkExternalMemoryImageCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExternalMemoryImageCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExternalMemoryImageCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
