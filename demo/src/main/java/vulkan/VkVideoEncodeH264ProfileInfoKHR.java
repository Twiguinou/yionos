...
public record VkVideoEncodeH264ProfileInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoEncodeH264ProfileInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoEncodeH264ProfileInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
