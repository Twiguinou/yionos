...
public record VkImageMemoryBarrier2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageMemoryBarrier2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageMemoryBarrier2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
