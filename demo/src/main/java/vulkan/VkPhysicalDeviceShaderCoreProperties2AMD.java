...
public record VkPhysicalDeviceShaderCoreProperties2AMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderCoreProperties2AMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderCoreProperties2AMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
