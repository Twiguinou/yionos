...
public record VkValidationCacheCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfLong LAYOUT__initialDataSize = java.lang.foreign.ValueLayout.JAVA_LONG;
    public static final long OFFSET__initialDataSize = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__pInitialData = jpgen.NativeTypes.UNBOUNDED_POINTER;
    ...
    ).withByteAlignment(8).withName("VkValidationCacheCreateInfoEXT");
    ...
    public static VkValidationCacheCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkValidationCacheCreateInfoEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkValidationCacheCreateInfoEXT value)
    {
