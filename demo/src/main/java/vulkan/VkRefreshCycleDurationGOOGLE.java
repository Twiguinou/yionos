...
public record VkRefreshCycleDurationGOOGLE(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRefreshCycleDurationGOOGLE getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRefreshCycleDurationGOOGLE(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
