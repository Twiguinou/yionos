...
public record VkPhysicalDeviceRayTracingPipelineFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingPipelineFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingPipelineFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
