...
public record StdVideoH265PredictorPaletteEntries(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265PredictorPaletteEntries getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265PredictorPaletteEntries(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
