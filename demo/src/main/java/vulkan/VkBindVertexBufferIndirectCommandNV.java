...
public record VkBindVertexBufferIndirectCommandNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindVertexBufferIndirectCommandNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindVertexBufferIndirectCommandNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
