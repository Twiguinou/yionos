...
public record VkVideoEncodeSessionParametersGetInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long OFFSET$videoSessionParameters = 16L;
    ...
    public static VkVideoEncodeSessionParametersGetInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoEncodeSessionParametersGetInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
