...
public record VkDescriptorSetLayoutBindingFlagsCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorSetLayoutBindingFlagsCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorSetLayoutBindingFlagsCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
