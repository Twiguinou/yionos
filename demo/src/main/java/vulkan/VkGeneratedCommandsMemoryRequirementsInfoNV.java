...
public record VkGeneratedCommandsMemoryRequirementsInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGeneratedCommandsMemoryRequirementsInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGeneratedCommandsMemoryRequirementsInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
