...
{
    public static final java.lang.foreign.UnionLayout LAYOUT__color = vulkan.VkClearColorValue.gRecordLayout;
    public static final java.lang.foreign.StructLayout LAYOUT__depthStencil = vulkan.VkClearDepthStencilValue.gRecordLayout;
    ...
    public vulkan.VkClearColorValue color() {return new vulkan.VkClearColorValue(this.ptr.asSlice(0, LAYOUT__color));}
    public void color(java.util.function.Consumer<vulkan.VkClearColorValue> consumer) {consumer.accept(this.color());}
    public void color(vulkan.VkClearColorValue value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, 0, LAYOUT__color.byteSize());}

    public vulkan.VkClearDepthStencilValue depthStencil() {return new vulkan.VkClearDepthStencilValue(this.ptr.asSlice(0, LAYOUT__depthStencil));}
    ...
    public void depthStencil(vulkan.VkClearDepthStencilValue value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, 0, LAYOUT__depthStencil.byteSize());}
}
