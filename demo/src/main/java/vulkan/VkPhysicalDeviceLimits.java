...
public record VkPhysicalDeviceLimits(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceLimits getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceLimits(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
