...
public record VkPhysicalDeviceCooperativeMatrixFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__cooperativeMatrix = java.lang.foreign.ValueLayout.JAVA_INT.withName("cooperativeMatrix");
    public static final long OFFSET__cooperativeMatrix = 16;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__cooperativeMatrixRobustBufferAccess = java.lang.foreign.ValueLayout.JAVA_INT.withName("cooperativeMatrixRobustBufferAccess");
    ...
    ).withByteAlignment(8).withName("VkPhysicalDeviceCooperativeMatrixFeaturesNV");
    ...
    public static VkPhysicalDeviceCooperativeMatrixFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkPhysicalDeviceCooperativeMatrixFeaturesNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkPhysicalDeviceCooperativeMatrixFeaturesNV value)
    {
