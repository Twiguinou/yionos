...
public record VkPhysicalDeviceCooperativeMatrixFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCooperativeMatrixFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCooperativeMatrixFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
