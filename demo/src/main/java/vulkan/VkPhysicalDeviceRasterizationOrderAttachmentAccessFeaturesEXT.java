...
public record VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
