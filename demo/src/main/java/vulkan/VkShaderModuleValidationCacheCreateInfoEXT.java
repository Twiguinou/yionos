...
public record VkShaderModuleValidationCacheCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkShaderModuleValidationCacheCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkShaderModuleValidationCacheCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
