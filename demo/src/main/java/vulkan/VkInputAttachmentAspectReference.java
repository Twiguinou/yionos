...
public record VkInputAttachmentAspectReference(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkInputAttachmentAspectReference getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkInputAttachmentAspectReference(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
