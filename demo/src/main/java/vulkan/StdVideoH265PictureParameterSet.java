...
public record StdVideoH265PictureParameterSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265PictureParameterSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265PictureParameterSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH265PpsFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
