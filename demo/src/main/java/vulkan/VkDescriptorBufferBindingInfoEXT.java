...
public record VkDescriptorBufferBindingInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorBufferBindingInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorBufferBindingInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
