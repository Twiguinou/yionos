...
public record VkPhysicalDevicePointClippingProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePointClippingProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePointClippingProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
