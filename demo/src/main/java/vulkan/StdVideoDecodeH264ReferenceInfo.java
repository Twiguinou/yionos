...
public record StdVideoDecodeH264ReferenceInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoDecodeH264ReferenceInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoDecodeH264ReferenceInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoDecodeH264ReferenceInfoFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
