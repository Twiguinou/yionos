...
public record VkPhysicalDeviceVulkanMemoryModelFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceVulkanMemoryModelFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceVulkanMemoryModelFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
