...
public record VkExtent2D(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExtent2D getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExtent2D(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
