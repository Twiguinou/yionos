...
public record VkExtent2D(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            LAYOUT__width,
            LAYOUT__height
    ).withByteAlignment(4).withName("VkExtent2D");
    ...
    public static VkExtent2D getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkExtent2D(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkExtent2D value)
    {
