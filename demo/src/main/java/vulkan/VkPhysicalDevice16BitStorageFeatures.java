...
public record VkPhysicalDevice16BitStorageFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevice16BitStorageFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevice16BitStorageFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
