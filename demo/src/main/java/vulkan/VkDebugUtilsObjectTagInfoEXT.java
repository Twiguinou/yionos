...
public record VkDebugUtilsObjectTagInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDebugUtilsObjectTagInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDebugUtilsObjectTagInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
