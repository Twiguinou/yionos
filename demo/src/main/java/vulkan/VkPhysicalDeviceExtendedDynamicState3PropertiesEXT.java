...
public record VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceExtendedDynamicState3PropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceExtendedDynamicState3PropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
