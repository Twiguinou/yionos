...
public record VkPhysicalDeviceShaderTerminateInvocationFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderTerminateInvocationFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderTerminateInvocationFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
