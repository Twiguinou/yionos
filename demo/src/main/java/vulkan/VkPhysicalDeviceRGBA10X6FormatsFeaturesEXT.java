...
public record VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
