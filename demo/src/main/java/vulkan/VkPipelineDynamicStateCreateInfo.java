...
public record VkPipelineDynamicStateCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineDynamicStateCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineDynamicStateCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
