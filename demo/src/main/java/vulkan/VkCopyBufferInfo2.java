...
public record VkCopyBufferInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyBufferInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyBufferInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
