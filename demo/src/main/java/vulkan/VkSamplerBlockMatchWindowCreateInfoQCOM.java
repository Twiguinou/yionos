...
public record VkSamplerBlockMatchWindowCreateInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSamplerBlockMatchWindowCreateInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSamplerBlockMatchWindowCreateInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void windowExtent(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$windowExtent, LAYOUT$windowExtent.byteSize());}
