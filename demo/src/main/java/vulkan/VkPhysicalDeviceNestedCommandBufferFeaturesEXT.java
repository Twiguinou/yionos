...
public record VkPhysicalDeviceNestedCommandBufferFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceNestedCommandBufferFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceNestedCommandBufferFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
