...
public record VkPhysicalDeviceVulkan11Features(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceVulkan11Features getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceVulkan11Features(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
