...
public record VkCopyCommandTransformInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyCommandTransformInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyCommandTransformInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
