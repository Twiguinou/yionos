...
public record VkCuModuleCreateInfoNVX(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCuModuleCreateInfoNVX getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCuModuleCreateInfoNVX(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
