...
public record VkDrmFormatModifierPropertiesListEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrmFormatModifierPropertiesListEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrmFormatModifierPropertiesListEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
