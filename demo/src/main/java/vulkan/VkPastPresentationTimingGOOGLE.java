...
public record VkPastPresentationTimingGOOGLE(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPastPresentationTimingGOOGLE getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPastPresentationTimingGOOGLE(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
