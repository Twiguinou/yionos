...
public record VkSubpassShadingPipelineCreateInfoHUAWEI(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubpassShadingPipelineCreateInfoHUAWEI getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubpassShadingPipelineCreateInfoHUAWEI(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
