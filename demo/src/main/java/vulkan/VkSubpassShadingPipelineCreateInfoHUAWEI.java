...
public record VkSubpassShadingPipelineCreateInfoHUAWEI(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__subpass,
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkSubpassShadingPipelineCreateInfoHUAWEI");
    ...
    public static VkSubpassShadingPipelineCreateInfoHUAWEI getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkSubpassShadingPipelineCreateInfoHUAWEI(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkSubpassShadingPipelineCreateInfoHUAWEI value)
    {
