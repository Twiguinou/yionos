...
public record VkPipelineLayoutCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineLayoutCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineLayoutCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
