...
public record VkDeviceQueueCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceQueueCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceQueueCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
