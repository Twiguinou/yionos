...
public record VkAccelerationStructureBuildRangeInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureBuildRangeInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureBuildRangeInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
