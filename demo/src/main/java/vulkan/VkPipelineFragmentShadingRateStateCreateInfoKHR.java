...
public record VkPipelineFragmentShadingRateStateCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineFragmentShadingRateStateCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineFragmentShadingRateStateCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
