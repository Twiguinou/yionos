...
public record VkSemaphoreWaitInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__semaphoreCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("semaphoreCount");
    public static final long OFFSET__semaphoreCount = 20;
    public static final java.lang.foreign.AddressLayout LAYOUT__pSemaphores = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pSemaphores");
