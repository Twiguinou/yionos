...
public record VkVideoDecodeH264DpbSlotInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH264DpbSlotInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH264DpbSlotInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
