...
public record VkAccelerationStructureMotionInstanceNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureMotionInstanceNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureMotionInstanceNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void data(vulkan.VkAccelerationStructureMotionInstanceDataNV value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$data, LAYOUT$data.byteSize());}
}
