...
public record VkCopyAccelerationStructureToMemoryInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__src = jpgen.NativeTypes.UNBOUNDED_POINTER;
    public static final long OFFSET__src = 16;
    public static final java.lang.foreign.UnionLayout LAYOUT__dst = vulkan.VkDeviceOrHostAddressKHR.gRecordLayout;
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__mode,
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkCopyAccelerationStructureToMemoryInfoKHR");
    ...
    public static VkCopyAccelerationStructureToMemoryInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkCopyAccelerationStructureToMemoryInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkCopyAccelerationStructureToMemoryInfoKHR value)
    {
