...
public record VkCopyAccelerationStructureToMemoryInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyAccelerationStructureToMemoryInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyAccelerationStructureToMemoryInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void dst(vulkan.VkDeviceOrHostAddressKHR value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$dst, LAYOUT$dst.byteSize());}
