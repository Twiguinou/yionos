...
public record VkImportMemoryHostPointerInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImportMemoryHostPointerInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImportMemoryHostPointerInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
