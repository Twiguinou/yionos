...
public record VkImportMemoryHostPointerInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long OFFSET__pHostPointer = 24;
    ...
    ).withByteAlignment(8).withName("VkImportMemoryHostPointerInfoEXT");
    ...
    public static VkImportMemoryHostPointerInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkImportMemoryHostPointerInfoEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkImportMemoryHostPointerInfoEXT value)
    {
