...
public record VkOpticalFlowSessionCreatePrivateDataInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkOpticalFlowSessionCreatePrivateDataInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkOpticalFlowSessionCreatePrivateDataInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
