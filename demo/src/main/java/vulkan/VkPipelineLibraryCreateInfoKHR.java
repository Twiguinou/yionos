...
public record VkPipelineLibraryCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineLibraryCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineLibraryCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
