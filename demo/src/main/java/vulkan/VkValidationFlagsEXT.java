...
public record VkValidationFlagsEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__disabledValidationCheckCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("disabledValidationCheckCount");
    public static final long OFFSET__disabledValidationCheckCount = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__pDisabledValidationChecks = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pDisabledValidationChecks");
