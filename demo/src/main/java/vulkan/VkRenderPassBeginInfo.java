...
public record VkRenderPassBeginInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassBeginInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassBeginInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
