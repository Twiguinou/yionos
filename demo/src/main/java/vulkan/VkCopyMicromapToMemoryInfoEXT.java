...
public record VkCopyMicromapToMemoryInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyMicromapToMemoryInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyMicromapToMemoryInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
