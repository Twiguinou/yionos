...
public record VkSubpassFragmentDensityMapOffsetEndInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__fragmentDensityOffsetCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("fragmentDensityOffsetCount");
    public static final long OFFSET__fragmentDensityOffsetCount = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__pFragmentDensityOffsets = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pFragmentDensityOffsets");
