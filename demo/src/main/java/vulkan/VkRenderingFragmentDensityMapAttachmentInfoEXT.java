...
public record VkRenderingFragmentDensityMapAttachmentInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderingFragmentDensityMapAttachmentInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderingFragmentDensityMapAttachmentInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
