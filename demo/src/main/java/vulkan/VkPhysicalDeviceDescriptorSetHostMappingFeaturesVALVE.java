...
public record VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
