...
public record VkPipelineRasterizationProvokingVertexStateCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineRasterizationProvokingVertexStateCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineRasterizationProvokingVertexStateCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
