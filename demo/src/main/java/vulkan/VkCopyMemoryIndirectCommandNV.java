...
public record VkCopyMemoryIndirectCommandNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyMemoryIndirectCommandNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyMemoryIndirectCommandNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
