...
public record VkVideoEncodeH265SessionParametersAddInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoEncodeH265SessionParametersAddInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoEncodeH265SessionParametersAddInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
