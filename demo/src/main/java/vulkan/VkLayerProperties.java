...
public record VkLayerProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkLayerProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkLayerProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
