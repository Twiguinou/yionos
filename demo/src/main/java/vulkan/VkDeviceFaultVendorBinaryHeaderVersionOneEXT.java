...
public record VkDeviceFaultVendorBinaryHeaderVersionOneEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceFaultVendorBinaryHeaderVersionOneEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceFaultVendorBinaryHeaderVersionOneEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
