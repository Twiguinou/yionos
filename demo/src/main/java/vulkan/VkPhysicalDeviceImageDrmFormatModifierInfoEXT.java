...
public record VkPhysicalDeviceImageDrmFormatModifierInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImageDrmFormatModifierInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImageDrmFormatModifierInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
