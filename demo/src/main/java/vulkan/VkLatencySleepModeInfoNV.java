...
public record VkLatencySleepModeInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkLatencySleepModeInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkLatencySleepModeInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
