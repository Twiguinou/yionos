...
public record VkPipelineViewportWScalingStateCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineViewportWScalingStateCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineViewportWScalingStateCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
