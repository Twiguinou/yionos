...
public record VkPipelineMultisampleStateCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineMultisampleStateCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineMultisampleStateCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
