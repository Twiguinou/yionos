...
public record VkMemoryDedicatedAllocateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__image,
            LAYOUT__buffer
    ).withByteAlignment(8).withName("VkMemoryDedicatedAllocateInfo");
    ...
    public static VkMemoryDedicatedAllocateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkMemoryDedicatedAllocateInfo(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkMemoryDedicatedAllocateInfo value)
    {
