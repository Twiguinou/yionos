...
public record VkPhysicalDeviceRobustness2PropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRobustness2PropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRobustness2PropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
