...
public record VkPhysicalDeviceColorWriteEnableFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceColorWriteEnableFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceColorWriteEnableFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
