...
public record VkImageCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
