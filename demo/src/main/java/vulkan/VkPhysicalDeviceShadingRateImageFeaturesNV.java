...
public record VkPhysicalDeviceShadingRateImageFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShadingRateImageFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShadingRateImageFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
