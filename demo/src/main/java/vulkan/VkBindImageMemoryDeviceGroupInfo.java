...
public record VkBindImageMemoryDeviceGroupInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindImageMemoryDeviceGroupInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindImageMemoryDeviceGroupInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
