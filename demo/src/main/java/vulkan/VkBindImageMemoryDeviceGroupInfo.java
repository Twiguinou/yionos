...
public record VkBindImageMemoryDeviceGroupInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__deviceIndexCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("deviceIndexCount");
    public static final long OFFSET__deviceIndexCount = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__pDeviceIndices = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pDeviceIndices");
    public static final long OFFSET__pDeviceIndices = 24;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__splitInstanceBindRegionCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("splitInstanceBindRegionCount");
    public static final long OFFSET__splitInstanceBindRegionCount = 32;
    public static final java.lang.foreign.AddressLayout LAYOUT__pSplitInstanceBindRegions = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pSplitInstanceBindRegions");
