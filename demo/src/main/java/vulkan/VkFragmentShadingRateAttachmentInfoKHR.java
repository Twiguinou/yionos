...
public record VkFragmentShadingRateAttachmentInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkFragmentShadingRateAttachmentInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkFragmentShadingRateAttachmentInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
