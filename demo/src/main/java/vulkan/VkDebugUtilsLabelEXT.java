...
public record VkDebugUtilsLabelEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDebugUtilsLabelEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDebugUtilsLabelEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
