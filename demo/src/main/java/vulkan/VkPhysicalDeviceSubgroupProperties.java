...
public record VkPhysicalDeviceSubgroupProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceSubgroupProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceSubgroupProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
