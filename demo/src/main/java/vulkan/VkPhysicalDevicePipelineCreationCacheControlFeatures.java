...
public record VkPhysicalDevicePipelineCreationCacheControlFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePipelineCreationCacheControlFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePipelineCreationCacheControlFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
