...
public record VkPhysicalDeviceHostImageCopyPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceHostImageCopyPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceHostImageCopyPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
