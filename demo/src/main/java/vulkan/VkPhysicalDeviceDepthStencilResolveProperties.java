...
public record VkPhysicalDeviceDepthStencilResolveProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDepthStencilResolveProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDepthStencilResolveProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
