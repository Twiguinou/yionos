...
public record VkDeviceMemoryOverallocationCreateInfoAMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceMemoryOverallocationCreateInfoAMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceMemoryOverallocationCreateInfoAMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
