...
public record StdVideoH264SequenceParameterSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH264SequenceParameterSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH264SequenceParameterSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH264SpsFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
