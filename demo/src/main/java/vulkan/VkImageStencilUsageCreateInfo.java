...
public record VkImageStencilUsageCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageStencilUsageCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageStencilUsageCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
