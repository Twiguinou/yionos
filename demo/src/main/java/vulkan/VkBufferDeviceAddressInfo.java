...
public record VkBufferDeviceAddressInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferDeviceAddressInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferDeviceAddressInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
