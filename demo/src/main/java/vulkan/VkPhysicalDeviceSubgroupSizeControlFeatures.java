...
public record VkPhysicalDeviceSubgroupSizeControlFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceSubgroupSizeControlFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceSubgroupSizeControlFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
