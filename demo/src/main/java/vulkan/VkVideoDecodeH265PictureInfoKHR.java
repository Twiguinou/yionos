...
public record VkVideoDecodeH265PictureInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH265PictureInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH265PictureInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
