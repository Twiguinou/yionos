...
public record VkImageViewAddressPropertiesNVX(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageViewAddressPropertiesNVX getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageViewAddressPropertiesNVX(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
