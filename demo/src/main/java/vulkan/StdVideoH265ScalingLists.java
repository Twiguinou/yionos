...
public record StdVideoH265ScalingLists(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265ScalingLists getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265ScalingLists(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
