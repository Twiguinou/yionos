...
public record VkVideoEncodeH264SessionParametersFeedbackInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long OFFSET__hasStdSPSOverrides = 16;
    ...
    public static final long OFFSET__hasStdPPSOverrides = 20;
    ...
    ).withByteAlignment(8).withName("VkVideoEncodeH264SessionParametersFeedbackInfoKHR");
    ...
    public static VkVideoEncodeH264SessionParametersFeedbackInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkVideoEncodeH264SessionParametersFeedbackInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkVideoEncodeH264SessionParametersFeedbackInfoKHR value)
    {
