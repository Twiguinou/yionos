...
public record VkDrawMeshTasksIndirectCommandNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrawMeshTasksIndirectCommandNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrawMeshTasksIndirectCommandNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
