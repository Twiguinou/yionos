...
public record VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
