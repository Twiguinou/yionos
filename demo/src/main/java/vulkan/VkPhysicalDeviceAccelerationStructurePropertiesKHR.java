...
public record VkPhysicalDeviceAccelerationStructurePropertiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceAccelerationStructurePropertiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceAccelerationStructurePropertiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
