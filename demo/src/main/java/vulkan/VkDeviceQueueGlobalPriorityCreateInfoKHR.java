...
public record VkDeviceQueueGlobalPriorityCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceQueueGlobalPriorityCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceQueueGlobalPriorityCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
