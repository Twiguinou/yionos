...
public record VkVideoDecodeH265SessionParametersCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH265SessionParametersCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH265SessionParametersCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
