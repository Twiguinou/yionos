...
public record VkGeometryTrianglesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGeometryTrianglesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGeometryTrianglesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
