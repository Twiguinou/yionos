...
public record VkAccelerationStructureGeometryTrianglesDataKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureGeometryTrianglesDataKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureGeometryTrianglesDataKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void indexData(vulkan.VkDeviceOrHostAddressConstKHR value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$indexData, LAYOUT$indexData.byteSize());}
    ...
    public void transformData(vulkan.VkDeviceOrHostAddressConstKHR value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$transformData, LAYOUT$transformData.byteSize());}
}
