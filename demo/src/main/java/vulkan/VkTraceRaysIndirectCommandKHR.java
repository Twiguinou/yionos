...
public record VkTraceRaysIndirectCommandKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__height,
            LAYOUT__depth
    ).withByteAlignment(4).withName("VkTraceRaysIndirectCommandKHR");
    ...
    public static VkTraceRaysIndirectCommandKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkTraceRaysIndirectCommandKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkTraceRaysIndirectCommandKHR value)
    {
