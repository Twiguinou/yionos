...
public record VkTraceRaysIndirectCommandKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkTraceRaysIndirectCommandKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkTraceRaysIndirectCommandKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
