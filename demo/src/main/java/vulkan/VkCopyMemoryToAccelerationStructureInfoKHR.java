...
public record VkCopyMemoryToAccelerationStructureInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyMemoryToAccelerationStructureInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyMemoryToAccelerationStructureInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
