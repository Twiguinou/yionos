...
public record VkPhysicalDeviceInlineUniformBlockFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceInlineUniformBlockFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceInlineUniformBlockFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
