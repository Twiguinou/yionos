...
public record VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
