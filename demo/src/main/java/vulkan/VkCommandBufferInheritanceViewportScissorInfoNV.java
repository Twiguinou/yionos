...
public record VkCommandBufferInheritanceViewportScissorInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCommandBufferInheritanceViewportScissorInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCommandBufferInheritanceViewportScissorInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
