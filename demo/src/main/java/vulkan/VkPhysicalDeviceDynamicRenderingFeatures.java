...
public record VkPhysicalDeviceDynamicRenderingFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDynamicRenderingFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDynamicRenderingFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
