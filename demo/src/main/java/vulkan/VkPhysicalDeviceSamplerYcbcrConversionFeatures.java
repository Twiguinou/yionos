...
public record VkPhysicalDeviceSamplerYcbcrConversionFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long OFFSET__samplerYcbcrConversion = 16;
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkPhysicalDeviceSamplerYcbcrConversionFeatures");
    ...
    public static VkPhysicalDeviceSamplerYcbcrConversionFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkPhysicalDeviceSamplerYcbcrConversionFeatures(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkPhysicalDeviceSamplerYcbcrConversionFeatures value)
    {
