...
public record VkFramebufferMixedSamplesCombinationNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkFramebufferMixedSamplesCombinationNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkFramebufferMixedSamplesCombinationNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
