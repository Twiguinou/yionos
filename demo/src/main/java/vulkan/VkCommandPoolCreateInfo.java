...
public record VkCommandPoolCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCommandPoolCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCommandPoolCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
