...
public record VkBindBufferMemoryInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindBufferMemoryInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindBufferMemoryInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
