...
public record VkPhysicalDeviceExtendedDynamicStateFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceExtendedDynamicStateFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceExtendedDynamicStateFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
