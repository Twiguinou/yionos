...
public record VkPhysicalDeviceVideoFormatInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceVideoFormatInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceVideoFormatInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
