...
public record VkPerformanceConfigurationAcquireInfoINTEL(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPerformanceConfigurationAcquireInfoINTEL getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPerformanceConfigurationAcquireInfoINTEL(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
