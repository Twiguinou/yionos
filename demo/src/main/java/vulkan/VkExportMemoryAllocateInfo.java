...
public record VkExportMemoryAllocateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExportMemoryAllocateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExportMemoryAllocateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
