...
public record VkPerformanceValueDataINTEL(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPerformanceValueDataINTEL getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPerformanceValueDataINTEL(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
