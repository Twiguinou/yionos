...
public record VkPushConstantRange(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPushConstantRange getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPushConstantRange(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
