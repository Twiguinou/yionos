...
public record VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
