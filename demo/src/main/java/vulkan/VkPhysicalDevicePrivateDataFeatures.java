...
public record VkPhysicalDevicePrivateDataFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePrivateDataFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePrivateDataFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
