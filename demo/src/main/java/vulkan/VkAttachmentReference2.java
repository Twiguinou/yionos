...
public record VkAttachmentReference2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAttachmentReference2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAttachmentReference2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
