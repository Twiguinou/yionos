...
public record VkBufferCaptureDescriptorDataInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBufferCaptureDescriptorDataInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBufferCaptureDescriptorDataInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
