...
public record VkPipelineCompilerControlCreateInfoAMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineCompilerControlCreateInfoAMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineCompilerControlCreateInfoAMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
