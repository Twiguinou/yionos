...
public record VkVideoDecodeH265SessionParametersAddInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            java.lang.foreign.MemoryLayout.paddingLayout(4),
            LAYOUT__pStdPPSs
    ).withByteAlignment(8).withName("VkVideoDecodeH265SessionParametersAddInfoKHR");
    ...
    public static VkVideoDecodeH265SessionParametersAddInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkVideoDecodeH265SessionParametersAddInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkVideoDecodeH265SessionParametersAddInfoKHR value)
    {
