...
public record VkVideoDecodeH265SessionParametersAddInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH265SessionParametersAddInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH265SessionParametersAddInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
