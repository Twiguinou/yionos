...
public record VkPhysicalDevicePCIBusInfoPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePCIBusInfoPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePCIBusInfoPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
