...
public record VkDeviceFaultVendorInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceFaultVendorInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceFaultVendorInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
