...
public record VkHdrMetadataEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkHdrMetadataEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkHdrMetadataEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void displayPrimaryRed(vulkan.VkXYColorEXT value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$displayPrimaryRed, LAYOUT$displayPrimaryRed.byteSize());}
    ...
    public void displayPrimaryGreen(vulkan.VkXYColorEXT value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$displayPrimaryGreen, LAYOUT$displayPrimaryGreen.byteSize());}
    ...
    public void displayPrimaryBlue(vulkan.VkXYColorEXT value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$displayPrimaryBlue, LAYOUT$displayPrimaryBlue.byteSize());}
    ...
    public void whitePoint(vulkan.VkXYColorEXT value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$whitePoint, LAYOUT$whitePoint.byteSize());}
