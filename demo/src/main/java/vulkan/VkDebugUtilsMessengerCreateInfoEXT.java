...
public record VkDebugUtilsMessengerCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDebugUtilsMessengerCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDebugUtilsMessengerCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
