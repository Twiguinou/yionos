...
public record VkPhysicalDeviceShaderFloat16Int8Features(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderFloat16Int8Features getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderFloat16Int8Features(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
