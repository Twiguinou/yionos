...
public record VkMemoryBarrier(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryBarrier getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryBarrier(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
