...
public record VkMemoryPriorityAllocateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryPriorityAllocateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryPriorityAllocateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
