...
public record VkVideoSessionParametersUpdateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoSessionParametersUpdateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoSessionParametersUpdateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
