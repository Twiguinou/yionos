...
public record VkDebugUtilsMessengerCallbackDataEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDebugUtilsMessengerCallbackDataEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDebugUtilsMessengerCallbackDataEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
