...
public record VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
