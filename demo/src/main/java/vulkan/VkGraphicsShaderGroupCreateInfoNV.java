...
public record VkGraphicsShaderGroupCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGraphicsShaderGroupCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGraphicsShaderGroupCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
