...
public record VkPhysicalDeviceCopyMemoryIndirectFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCopyMemoryIndirectFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCopyMemoryIndirectFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
