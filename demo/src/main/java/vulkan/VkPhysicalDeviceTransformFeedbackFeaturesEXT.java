...
public record VkPhysicalDeviceTransformFeedbackFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTransformFeedbackFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTransformFeedbackFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
