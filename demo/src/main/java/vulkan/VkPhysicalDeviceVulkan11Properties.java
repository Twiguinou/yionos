...
public record VkPhysicalDeviceVulkan11Properties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceVulkan11Properties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceVulkan11Properties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
