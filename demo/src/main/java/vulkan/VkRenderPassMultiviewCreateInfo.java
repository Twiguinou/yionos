...
public record VkRenderPassMultiviewCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassMultiviewCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassMultiviewCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
