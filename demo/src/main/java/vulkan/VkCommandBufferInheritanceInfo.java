...
public record VkCommandBufferInheritanceInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCommandBufferInheritanceInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCommandBufferInheritanceInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
