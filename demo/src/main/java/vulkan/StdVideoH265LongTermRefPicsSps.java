...
public record StdVideoH265LongTermRefPicsSps(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265LongTermRefPicsSps getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265LongTermRefPicsSps(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
