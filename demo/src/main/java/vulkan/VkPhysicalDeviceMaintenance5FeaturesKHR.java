...
public record VkPhysicalDeviceMaintenance5FeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceMaintenance5FeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceMaintenance5FeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
