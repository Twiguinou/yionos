...
public record StdVideoH265SequenceParameterSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265SequenceParameterSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265SequenceParameterSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH265SpsFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
