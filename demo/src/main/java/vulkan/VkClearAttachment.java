...
public record VkClearAttachment(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkClearAttachment getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkClearAttachment(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
