...
public record VkAccelerationStructureCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAccelerationStructureCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAccelerationStructureCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void info(vulkan.VkAccelerationStructureInfoNV value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$info, LAYOUT$info.byteSize());}
}
