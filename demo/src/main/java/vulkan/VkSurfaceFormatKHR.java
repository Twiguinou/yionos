...
public record VkSurfaceFormatKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSurfaceFormatKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSurfaceFormatKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
