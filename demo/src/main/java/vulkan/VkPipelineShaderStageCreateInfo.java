...
public record VkPipelineShaderStageCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineShaderStageCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineShaderStageCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
