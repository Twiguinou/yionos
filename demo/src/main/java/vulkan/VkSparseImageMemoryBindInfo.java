...
public record VkSparseImageMemoryBindInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__pBinds
    ).withByteAlignment(8).withName("VkSparseImageMemoryBindInfo");
    ...
    public static VkSparseImageMemoryBindInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkSparseImageMemoryBindInfo(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkSparseImageMemoryBindInfo value)
    {
