...
public record VkSparseImageMemoryBindInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSparseImageMemoryBindInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSparseImageMemoryBindInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
