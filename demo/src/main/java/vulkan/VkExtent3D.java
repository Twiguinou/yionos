...
public record VkExtent3D(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExtent3D getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExtent3D(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
