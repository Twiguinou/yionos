...
public record VkGeometryAABBNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkGeometryAABBNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkGeometryAABBNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
