...
public record VkSamplerCaptureDescriptorDataInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSamplerCaptureDescriptorDataInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSamplerCaptureDescriptorDataInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
