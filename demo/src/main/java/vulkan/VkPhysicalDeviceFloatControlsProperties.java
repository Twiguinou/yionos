...
public record VkPhysicalDeviceFloatControlsProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFloatControlsProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFloatControlsProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
