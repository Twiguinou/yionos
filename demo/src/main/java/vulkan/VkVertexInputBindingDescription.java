...
public record VkVertexInputBindingDescription(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVertexInputBindingDescription getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVertexInputBindingDescription(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
