...
public record VkPhysicalDeviceGroupProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.SequenceLayout LAYOUT__physicalDevices = java.lang.foreign.MemoryLayout.sequenceLayout(32, jpgen.NativeTypes.UNBOUNDED_POINTER).withName("physicalDevices");
    public static final long OFFSET__physicalDevices = 24;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__subsetAllocation = java.lang.foreign.ValueLayout.JAVA_INT.withName("subsetAllocation");
