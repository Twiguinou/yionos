...
public record VkPhysicalDeviceGroupProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceGroupProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceGroupProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
