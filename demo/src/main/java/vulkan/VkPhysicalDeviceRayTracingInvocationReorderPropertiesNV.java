...
public record VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
