...
public record VkRayTracingShaderGroupCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRayTracingShaderGroupCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRayTracingShaderGroupCreateInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
