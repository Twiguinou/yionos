...
public record VkRayTracingShaderGroupCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__generalShader = java.lang.foreign.ValueLayout.JAVA_INT.withName("generalShader");
    public static final long OFFSET__generalShader = 20;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__closestHitShader = java.lang.foreign.ValueLayout.JAVA_INT.withName("closestHitShader");
    public static final long OFFSET__closestHitShader = 24;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__anyHitShader = java.lang.foreign.ValueLayout.JAVA_INT.withName("anyHitShader");
    public static final long OFFSET__anyHitShader = 28;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__intersectionShader = java.lang.foreign.ValueLayout.JAVA_INT.withName("intersectionShader");
    public static final long OFFSET__intersectionShader = 32;
    public static final java.lang.foreign.AddressLayout LAYOUT__pShaderGroupCaptureReplayHandle = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pShaderGroupCaptureReplayHandle");
    public static final long OFFSET__pShaderGroupCaptureReplayHandle = 40;
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            java.lang.foreign.MemoryLayout.paddingLayout(4),
            LAYOUT__pShaderGroupCaptureReplayHandle
    ).withByteAlignment(8).withName("VkRayTracingShaderGroupCreateInfoKHR");
    ...
    public static VkRayTracingShaderGroupCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkRayTracingShaderGroupCreateInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkRayTracingShaderGroupCreateInfoKHR value)
    {
    ...
    public java.lang.foreign.MemorySegment pShaderGroupCaptureReplayHandle() {return this.ptr.get(LAYOUT__pShaderGroupCaptureReplayHandle, OFFSET__pShaderGroupCaptureReplayHandle);}
    public void pShaderGroupCaptureReplayHandle(java.lang.foreign.MemorySegment value) {this.ptr.set(LAYOUT__pShaderGroupCaptureReplayHandle, OFFSET__pShaderGroupCaptureReplayHandle, value);}
    public java.lang.foreign.MemorySegment $pShaderGroupCaptureReplayHandle() {return this.ptr.asSlice(OFFSET__pShaderGroupCaptureReplayHandle, LAYOUT__pShaderGroupCaptureReplayHandle);}
}
