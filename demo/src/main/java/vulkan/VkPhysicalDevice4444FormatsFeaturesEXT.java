...
public record VkPhysicalDevice4444FormatsFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevice4444FormatsFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevice4444FormatsFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
