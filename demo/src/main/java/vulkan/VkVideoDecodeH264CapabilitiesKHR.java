...
public record VkVideoDecodeH264CapabilitiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoDecodeH264CapabilitiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoDecodeH264CapabilitiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void fieldOffsetGranularity(vulkan.VkOffset2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$fieldOffsetGranularity, LAYOUT$fieldOffsetGranularity.byteSize());}
}
