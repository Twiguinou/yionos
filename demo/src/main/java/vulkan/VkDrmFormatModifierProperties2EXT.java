...
public record VkDrmFormatModifierProperties2EXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrmFormatModifierProperties2EXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrmFormatModifierProperties2EXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
