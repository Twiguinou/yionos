...
public record VkAttachmentSampleCountInfoAMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAttachmentSampleCountInfoAMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAttachmentSampleCountInfoAMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
