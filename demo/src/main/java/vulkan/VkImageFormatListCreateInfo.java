...
public record VkImageFormatListCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageFormatListCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageFormatListCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
