...
public record VkQueryPoolCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkQueryPoolCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkQueryPoolCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
