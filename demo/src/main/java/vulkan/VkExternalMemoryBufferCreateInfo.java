...
public record VkExternalMemoryBufferCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__handleTypes,
            java.lang.foreign.MemoryLayout.paddingLayout(4)
    ).withByteAlignment(8).withName("VkExternalMemoryBufferCreateInfo");
    ...
    public static VkExternalMemoryBufferCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkExternalMemoryBufferCreateInfo(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkExternalMemoryBufferCreateInfo value)
    {
