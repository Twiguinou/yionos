...
public record VkPhysicalDeviceShaderTileImageFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderTileImageFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderTileImageFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
