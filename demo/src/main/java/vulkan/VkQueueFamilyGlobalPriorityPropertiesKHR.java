...
public record VkQueueFamilyGlobalPriorityPropertiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkQueueFamilyGlobalPriorityPropertiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkQueueFamilyGlobalPriorityPropertiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
