...
public record VkClearColorValue(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkClearColorValue getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkClearColorValue(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
