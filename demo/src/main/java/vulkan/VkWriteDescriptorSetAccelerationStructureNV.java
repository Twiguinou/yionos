...
public record VkWriteDescriptorSetAccelerationStructureNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__accelerationStructureCount = java.lang.foreign.ValueLayout.JAVA_INT.withName("accelerationStructureCount");
    public static final long OFFSET__accelerationStructureCount = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__pAccelerationStructures = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pAccelerationStructures");
    ...
    ).withByteAlignment(8).withName("VkWriteDescriptorSetAccelerationStructureNV");
    ...
    public static VkWriteDescriptorSetAccelerationStructureNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkWriteDescriptorSetAccelerationStructureNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkWriteDescriptorSetAccelerationStructureNV value)
    {
