...
public record VkWriteDescriptorSetAccelerationStructureNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkWriteDescriptorSetAccelerationStructureNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkWriteDescriptorSetAccelerationStructureNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
