...
public record StdVideoDecodeH264PictureInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoDecodeH264PictureInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoDecodeH264PictureInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoDecodeH264PictureInfoFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
