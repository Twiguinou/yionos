...
public record VkAcquireProfilingLockInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAcquireProfilingLockInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAcquireProfilingLockInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
