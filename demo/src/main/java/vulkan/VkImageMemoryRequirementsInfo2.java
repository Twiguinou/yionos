...
public record VkImageMemoryRequirementsInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageMemoryRequirementsInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageMemoryRequirementsInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
