...
public record VkAllocationCallbacks(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkAllocationCallbacks getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkAllocationCallbacks(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
