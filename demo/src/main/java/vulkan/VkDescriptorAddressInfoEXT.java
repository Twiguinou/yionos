...
public record VkDescriptorAddressInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorAddressInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorAddressInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
