...
public record VkImageSparseMemoryRequirementsInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageSparseMemoryRequirementsInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageSparseMemoryRequirementsInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
