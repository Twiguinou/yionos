...
public record VkPhysicalDeviceFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
