...
public record VkSurfacePresentScalingCapabilitiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSurfacePresentScalingCapabilitiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSurfacePresentScalingCapabilitiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void minScaledImageExtent(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$minScaledImageExtent, LAYOUT$minScaledImageExtent.byteSize());}
    ...
    public void maxScaledImageExtent(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$maxScaledImageExtent, LAYOUT$maxScaledImageExtent.byteSize());}
}
