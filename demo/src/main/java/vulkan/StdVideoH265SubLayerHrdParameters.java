...
public record StdVideoH265SubLayerHrdParameters(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265SubLayerHrdParameters getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265SubLayerHrdParameters(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
