...
public record VkPhysicalDeviceImage2DViewOf3DFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImage2DViewOf3DFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImage2DViewOf3DFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
