...
public record VkCommandBufferSubmitInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCommandBufferSubmitInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCommandBufferSubmitInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
