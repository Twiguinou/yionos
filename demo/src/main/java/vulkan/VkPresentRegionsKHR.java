...
public record VkPresentRegionsKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            java.lang.foreign.MemoryLayout.paddingLayout(4),
            LAYOUT__pRegions
    ).withByteAlignment(8).withName("VkPresentRegionsKHR");
    ...
    public static VkPresentRegionsKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkPresentRegionsKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkPresentRegionsKHR value)
    {
