...
public record VkPresentRegionsKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPresentRegionsKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPresentRegionsKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
