...
public record VkPhysicalDeviceDepthBiasControlFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDepthBiasControlFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDepthBiasControlFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
