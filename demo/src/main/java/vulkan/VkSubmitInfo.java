...
public record VkSubmitInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubmitInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubmitInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
