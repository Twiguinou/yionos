...
public record VkSubmitInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pWaitDstStageMask = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pWaitDstStageMask");
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__pCommandBuffers = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("pCommandBuffers");
