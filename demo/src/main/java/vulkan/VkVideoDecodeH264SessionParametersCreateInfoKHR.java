...
public record VkVideoDecodeH264SessionParametersCreateInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    ).withByteAlignment(8).withName("VkVideoDecodeH264SessionParametersCreateInfoKHR");
    ...
    public static VkVideoDecodeH264SessionParametersCreateInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkVideoDecodeH264SessionParametersCreateInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkVideoDecodeH264SessionParametersCreateInfoKHR value)
    {
