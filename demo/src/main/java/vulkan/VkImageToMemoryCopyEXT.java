...
public record VkImageToMemoryCopyEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageToMemoryCopyEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageToMemoryCopyEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
