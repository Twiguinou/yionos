...
public record VkDescriptorBufferInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorBufferInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorBufferInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
