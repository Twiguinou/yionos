...
public record VkImageCompressionPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageCompressionPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageCompressionPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
