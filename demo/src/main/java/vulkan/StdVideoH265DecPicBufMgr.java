...
public record StdVideoH265DecPicBufMgr(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265DecPicBufMgr getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265DecPicBufMgr(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
