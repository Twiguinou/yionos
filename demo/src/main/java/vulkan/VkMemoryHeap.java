...
public record VkMemoryHeap(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryHeap getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryHeap(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
