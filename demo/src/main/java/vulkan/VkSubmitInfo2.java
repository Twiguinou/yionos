...
public record VkSubmitInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubmitInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubmitInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
