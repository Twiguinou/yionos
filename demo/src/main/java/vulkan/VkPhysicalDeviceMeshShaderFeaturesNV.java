...
public record VkPhysicalDeviceMeshShaderFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceMeshShaderFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceMeshShaderFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
