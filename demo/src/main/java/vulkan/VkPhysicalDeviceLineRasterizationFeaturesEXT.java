...
public record VkPhysicalDeviceLineRasterizationFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceLineRasterizationFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceLineRasterizationFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
