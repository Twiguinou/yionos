...
public record VkPhysicalDeviceCoherentMemoryFeaturesAMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCoherentMemoryFeaturesAMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCoherentMemoryFeaturesAMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
