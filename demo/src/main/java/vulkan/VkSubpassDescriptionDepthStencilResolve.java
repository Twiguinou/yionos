...
public record VkSubpassDescriptionDepthStencilResolve(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSubpassDescriptionDepthStencilResolve getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSubpassDescriptionDepthStencilResolve(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
