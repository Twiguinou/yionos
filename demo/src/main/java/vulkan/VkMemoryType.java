...
public record VkMemoryType(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMemoryType getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMemoryType(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
