...
public record VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
