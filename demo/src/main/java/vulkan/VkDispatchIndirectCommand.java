...
public record VkDispatchIndirectCommand(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDispatchIndirectCommand getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDispatchIndirectCommand(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
