...
public record VkDispatchIndirectCommand(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__y,
            LAYOUT__z
    ).withByteAlignment(4).withName("VkDispatchIndirectCommand");
    ...
    public static VkDispatchIndirectCommand getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkDispatchIndirectCommand(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkDispatchIndirectCommand value)
    {
