...
public record VkVideoReferenceSlotInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVideoReferenceSlotInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVideoReferenceSlotInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
