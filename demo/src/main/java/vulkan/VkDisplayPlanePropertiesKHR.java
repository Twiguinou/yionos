...
public record VkDisplayPlanePropertiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDisplayPlanePropertiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDisplayPlanePropertiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
