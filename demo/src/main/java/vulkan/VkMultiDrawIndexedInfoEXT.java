...
public record VkMultiDrawIndexedInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkMultiDrawIndexedInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkMultiDrawIndexedInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
