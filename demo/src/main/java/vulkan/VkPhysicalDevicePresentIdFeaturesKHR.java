...
public record VkPhysicalDevicePresentIdFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePresentIdFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePresentIdFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
