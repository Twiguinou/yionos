...
public record VkPhysicalDeviceRayTracingPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
