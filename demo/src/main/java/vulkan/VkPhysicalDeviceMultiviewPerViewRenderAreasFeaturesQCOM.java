...
public record VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
