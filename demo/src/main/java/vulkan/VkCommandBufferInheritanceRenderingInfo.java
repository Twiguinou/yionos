...
public record VkCommandBufferInheritanceRenderingInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCommandBufferInheritanceRenderingInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCommandBufferInheritanceRenderingInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
