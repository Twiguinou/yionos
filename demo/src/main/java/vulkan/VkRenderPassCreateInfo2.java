...
public record VkRenderPassCreateInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassCreateInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassCreateInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
