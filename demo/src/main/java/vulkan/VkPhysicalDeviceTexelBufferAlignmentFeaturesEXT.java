...
public record VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
