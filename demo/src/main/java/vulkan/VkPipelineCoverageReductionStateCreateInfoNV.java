...
public record VkPipelineCoverageReductionStateCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineCoverageReductionStateCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineCoverageReductionStateCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
