...
public record VkPhysicalDeviceCooperativeMatrixPropertiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCooperativeMatrixPropertiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCooperativeMatrixPropertiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
