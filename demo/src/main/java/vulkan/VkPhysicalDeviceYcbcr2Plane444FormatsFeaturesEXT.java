...
public record VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
