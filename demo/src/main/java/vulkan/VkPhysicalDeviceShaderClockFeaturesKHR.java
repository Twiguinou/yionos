...
public record VkPhysicalDeviceShaderClockFeaturesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderClockFeaturesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderClockFeaturesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
