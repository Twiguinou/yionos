...
public record VkDeviceGroupPresentInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDeviceGroupPresentInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDeviceGroupPresentInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
