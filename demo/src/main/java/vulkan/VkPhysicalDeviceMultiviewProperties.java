...
public record VkPhysicalDeviceMultiviewProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceMultiviewProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceMultiviewProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
