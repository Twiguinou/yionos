...
public record VkExternalMemoryImageCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExternalMemoryImageCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExternalMemoryImageCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
