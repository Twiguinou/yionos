...
public record VkVertexInputBindingDivisorDescriptionKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkVertexInputBindingDivisorDescriptionKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkVertexInputBindingDivisorDescriptionKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
