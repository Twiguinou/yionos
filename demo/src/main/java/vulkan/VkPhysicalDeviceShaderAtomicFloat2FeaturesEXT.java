...
public record VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
