...
public record VkPhysicalDeviceImageProcessingPropertiesQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImageProcessingPropertiesQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImageProcessingPropertiesQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void maxWeightFilterDimension(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$maxWeightFilterDimension, LAYOUT$maxWeightFilterDimension.byteSize());}
    ...
    public void maxBlockMatchRegion(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$maxBlockMatchRegion, LAYOUT$maxBlockMatchRegion.byteSize());}
    ...
    public void maxBoxFilterBlockSize(vulkan.VkExtent2D value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$maxBoxFilterBlockSize, LAYOUT$maxBoxFilterBlockSize.byteSize());}
}
