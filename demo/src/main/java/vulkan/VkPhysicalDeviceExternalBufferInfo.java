...
public record VkPhysicalDeviceExternalBufferInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceExternalBufferInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceExternalBufferInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
