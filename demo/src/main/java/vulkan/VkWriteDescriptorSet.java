...
public record VkWriteDescriptorSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkWriteDescriptorSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkWriteDescriptorSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
