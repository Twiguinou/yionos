...
public record VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
