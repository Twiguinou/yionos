...
public record VkSurfaceCapabilitiesKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSurfaceCapabilitiesKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSurfaceCapabilitiesKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
