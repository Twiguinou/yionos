...
public record VkIndirectCommandsStreamNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkIndirectCommandsStreamNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkIndirectCommandsStreamNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
