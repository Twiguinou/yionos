...
public record VkExternalImageFormatPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExternalImageFormatPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExternalImageFormatPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void imageFormatProperties(vulkan.VkImageFormatProperties value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$imageFormatProperties, LAYOUT$imageFormatProperties.byteSize());}
