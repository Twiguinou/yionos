...
public record VkExternalFenceProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExternalFenceProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExternalFenceProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
