...
public record VkClearDepthStencilValue(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkClearDepthStencilValue getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkClearDepthStencilValue(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
