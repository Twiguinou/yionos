...
public record VkPhysicalDeviceSubgroupSizeControlProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceSubgroupSizeControlProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceSubgroupSizeControlProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
