...
public record VkPhysicalDeviceShaderCorePropertiesAMD(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderCorePropertiesAMD getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderCorePropertiesAMD(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
