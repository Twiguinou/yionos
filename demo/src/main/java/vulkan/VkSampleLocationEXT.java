...
public record VkSampleLocationEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            LAYOUT__x,
            LAYOUT__y
    ).withByteAlignment(4).withName("VkSampleLocationEXT");
    ...
    public static VkSampleLocationEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkSampleLocationEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkSampleLocationEXT value)
    {
