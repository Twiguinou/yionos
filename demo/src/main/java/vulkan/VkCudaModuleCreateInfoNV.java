...
public record VkCudaModuleCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__dataSize,
            LAYOUT__pData
    ).withByteAlignment(8).withName("VkCudaModuleCreateInfoNV");
    ...
    public static VkCudaModuleCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkCudaModuleCreateInfoNV(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkCudaModuleCreateInfoNV value)
    {
