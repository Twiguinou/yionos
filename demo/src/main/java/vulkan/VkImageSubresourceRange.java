...
public record VkImageSubresourceRange(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageSubresourceRange getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageSubresourceRange(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
