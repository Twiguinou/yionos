...
public record VkPhysicalDeviceImageRobustnessFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceImageRobustnessFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceImageRobustnessFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
