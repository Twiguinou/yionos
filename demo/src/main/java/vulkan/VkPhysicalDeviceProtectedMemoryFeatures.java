...
public record VkPhysicalDeviceProtectedMemoryFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceProtectedMemoryFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceProtectedMemoryFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
