...
public record VkBindImageMemorySwapchainInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindImageMemorySwapchainInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindImageMemorySwapchainInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
