...
public record VkPerformanceCounterKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPerformanceCounterKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPerformanceCounterKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
