...
public record VkDrawIndirectCommand(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDrawIndirectCommand getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDrawIndirectCommand(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
