...
public record VkDepthBiasRepresentationInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDepthBiasRepresentationInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDepthBiasRepresentationInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
