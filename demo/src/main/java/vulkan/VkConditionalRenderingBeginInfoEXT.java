...
public record VkConditionalRenderingBeginInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkConditionalRenderingBeginInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkConditionalRenderingBeginInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
