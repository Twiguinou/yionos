...
public record VkInitializePerformanceApiInfoINTEL(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkInitializePerformanceApiInfoINTEL getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkInitializePerformanceApiInfoINTEL(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
