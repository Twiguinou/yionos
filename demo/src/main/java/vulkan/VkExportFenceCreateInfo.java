...
public record VkExportFenceCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExportFenceCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExportFenceCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
