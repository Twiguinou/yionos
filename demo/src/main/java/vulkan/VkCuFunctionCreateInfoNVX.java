...
public record VkCuFunctionCreateInfoNVX(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCuFunctionCreateInfoNVX getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCuFunctionCreateInfoNVX(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
