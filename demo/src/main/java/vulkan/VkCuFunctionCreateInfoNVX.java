...
public record VkCuFunctionCreateInfoNVX(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__module,
            LAYOUT__pName
    ).withByteAlignment(8).withName("VkCuFunctionCreateInfoNVX");
    ...
    public static VkCuFunctionCreateInfoNVX getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkCuFunctionCreateInfoNVX(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkCuFunctionCreateInfoNVX value)
    {
