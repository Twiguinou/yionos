...
public record VkPhysicalDeviceShaderIntegerDotProductFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceShaderIntegerDotProductFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceShaderIntegerDotProductFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
