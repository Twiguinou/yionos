...
public record VkPhysicalDeviceDescriptorBufferPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceDescriptorBufferPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceDescriptorBufferPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
