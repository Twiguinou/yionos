...
public record VkDescriptorSetAllocateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorSetAllocateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorSetAllocateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
