...
public record StdVideoH265VideoParameterSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH265VideoParameterSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH265VideoParameterSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH265VpsFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
