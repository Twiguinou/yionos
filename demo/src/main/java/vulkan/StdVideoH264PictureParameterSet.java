...
public record StdVideoH264PictureParameterSet(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH264PictureParameterSet getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH264PictureParameterSet(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH264PpsFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
