...
public record VkPhysicalDevicePipelineRobustnessPropertiesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDevicePipelineRobustnessPropertiesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDevicePipelineRobustnessPropertiesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
