...
public record VkPhysicalDeviceUniformBufferStandardLayoutFeatures(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceUniformBufferStandardLayoutFeatures getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceUniformBufferStandardLayoutFeatures(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
