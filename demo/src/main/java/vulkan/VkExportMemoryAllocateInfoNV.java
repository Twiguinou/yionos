...
public record VkExportMemoryAllocateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExportMemoryAllocateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExportMemoryAllocateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
