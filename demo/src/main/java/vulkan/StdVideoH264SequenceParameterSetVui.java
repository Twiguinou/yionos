...
public record StdVideoH264SequenceParameterSetVui(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH264SequenceParameterSetVui getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH264SequenceParameterSetVui(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void flags(vulkan.StdVideoH264SpsVuiFlags value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$flags, LAYOUT$flags.byteSize());}
