...
public record VkSwapchainPresentModesCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkSwapchainPresentModesCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkSwapchainPresentModesCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
