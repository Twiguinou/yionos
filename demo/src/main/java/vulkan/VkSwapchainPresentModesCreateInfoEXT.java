...
public record VkSwapchainPresentModesCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__presentModeCount = java.lang.foreign.ValueLayout.JAVA_INT;
    ...
    ).withByteAlignment(8).withName("VkSwapchainPresentModesCreateInfoEXT");
    ...
    public static VkSwapchainPresentModesCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkSwapchainPresentModesCreateInfoEXT(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkSwapchainPresentModesCreateInfoEXT value)
    {
