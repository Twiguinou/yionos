...
public record VkImageDrmFormatModifierExplicitCreateInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkImageDrmFormatModifierExplicitCreateInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkImageDrmFormatModifierExplicitCreateInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
