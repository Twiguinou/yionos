...
public record VkPhysicalDeviceCubicClampFeaturesQCOM(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceCubicClampFeaturesQCOM getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceCubicClampFeaturesQCOM(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
