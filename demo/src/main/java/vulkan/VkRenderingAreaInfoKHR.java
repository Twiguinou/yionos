...
public record VkRenderingAreaInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderingAreaInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderingAreaInfoKHR(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
