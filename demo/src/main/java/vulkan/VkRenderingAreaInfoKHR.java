...
public record VkRenderingAreaInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    ).withByteAlignment(8).withName("VkRenderingAreaInfoKHR");
    ...
    public static VkRenderingAreaInfoKHR getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new VkRenderingAreaInfoKHR(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, VkRenderingAreaInfoKHR value)
    {
