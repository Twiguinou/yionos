...
public record VkPhysicalDeviceTexelBufferAlignmentProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceTexelBufferAlignmentProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceTexelBufferAlignmentProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
