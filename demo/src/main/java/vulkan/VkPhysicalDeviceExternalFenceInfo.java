...
public record VkPhysicalDeviceExternalFenceInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceExternalFenceInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceExternalFenceInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
