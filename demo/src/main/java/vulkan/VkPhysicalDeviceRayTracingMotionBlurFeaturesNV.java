...
public record VkPhysicalDeviceRayTracingMotionBlurFeaturesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceRayTracingMotionBlurFeaturesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceRayTracingMotionBlurFeaturesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
