...
public record VkPhysicalDeviceOpticalFlowPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceOpticalFlowPropertiesNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceOpticalFlowPropertiesNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
