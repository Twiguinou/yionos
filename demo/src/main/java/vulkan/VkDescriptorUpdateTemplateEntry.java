...
public record VkDescriptorUpdateTemplateEntry(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkDescriptorUpdateTemplateEntry getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkDescriptorUpdateTemplateEntry(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
