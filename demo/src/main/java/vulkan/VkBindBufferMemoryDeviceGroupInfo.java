...
public record VkBindBufferMemoryDeviceGroupInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindBufferMemoryDeviceGroupInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindBufferMemoryDeviceGroupInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
