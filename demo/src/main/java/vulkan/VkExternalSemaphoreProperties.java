...
public record VkExternalSemaphoreProperties(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkExternalSemaphoreProperties getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkExternalSemaphoreProperties(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
