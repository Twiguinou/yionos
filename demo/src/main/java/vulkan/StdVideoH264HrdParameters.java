...
public record StdVideoH264HrdParameters(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static StdVideoH264HrdParameters getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new StdVideoH264HrdParameters(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
