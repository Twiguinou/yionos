...
public record VkLatencySleepInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkLatencySleepInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkLatencySleepInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
