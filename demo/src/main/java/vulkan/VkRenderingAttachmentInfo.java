...
public record VkRenderingAttachmentInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderingAttachmentInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderingAttachmentInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public void clearValue(vulkan.VkClearValue value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET$clearValue, LAYOUT$clearValue.byteSize());}
}
