...
public record VkPipelineFragmentShadingRateEnumStateCreateInfoNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPipelineFragmentShadingRateEnumStateCreateInfoNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPipelineFragmentShadingRateEnumStateCreateInfoNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
