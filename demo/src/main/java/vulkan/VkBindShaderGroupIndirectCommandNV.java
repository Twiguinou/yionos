...
public record VkBindShaderGroupIndirectCommandNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkBindShaderGroupIndirectCommandNV getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkBindShaderGroupIndirectCommandNV(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
