...
public record VkPhysicalDeviceFrameBoundaryFeaturesEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkPhysicalDeviceFrameBoundaryFeaturesEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkPhysicalDeviceFrameBoundaryFeaturesEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
