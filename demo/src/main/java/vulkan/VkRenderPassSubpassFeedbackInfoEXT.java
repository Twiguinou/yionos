...
public record VkRenderPassSubpassFeedbackInfoEXT(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassSubpassFeedbackInfoEXT getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassSubpassFeedbackInfoEXT(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
