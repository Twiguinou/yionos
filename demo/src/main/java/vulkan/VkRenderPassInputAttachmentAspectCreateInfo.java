...
public record VkRenderPassInputAttachmentAspectCreateInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkRenderPassInputAttachmentAspectCreateInfo getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkRenderPassInputAttachmentAspectCreateInfo(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
