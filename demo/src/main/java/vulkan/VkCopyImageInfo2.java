...
public record VkCopyImageInfo2(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static VkCopyImageInfo2 getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new VkCopyImageInfo2(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
