...
public record nk_style_edit(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__scrollbar = nuklear.nk_style_scrollbar.gRecordLayout.withName("scrollbar");
    public static final long OFFSET__scrollbar = 128;
    public static final java.lang.foreign.StructLayout LAYOUT__cursor_normal = nuklear.nk_color.gRecordLayout.withName("cursor_normal");
    public static final long OFFSET__cursor_normal = 880;
    public static final java.lang.foreign.StructLayout LAYOUT__cursor_hover = nuklear.nk_color.gRecordLayout.withName("cursor_hover");
    public static final long OFFSET__cursor_hover = 884;
    public static final java.lang.foreign.StructLayout LAYOUT__cursor_text_normal = nuklear.nk_color.gRecordLayout.withName("cursor_text_normal");
    public static final long OFFSET__cursor_text_normal = 888;
    public static final java.lang.foreign.StructLayout LAYOUT__cursor_text_hover = nuklear.nk_color.gRecordLayout.withName("cursor_text_hover");
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__text_active = nuklear.nk_color.gRecordLayout.withName("text_active");
    public static final long OFFSET__text_active = 904;
    public static final java.lang.foreign.StructLayout LAYOUT__selected_normal = nuklear.nk_color.gRecordLayout.withName("selected_normal");
    public static final long OFFSET__selected_normal = 908;
    public static final java.lang.foreign.StructLayout LAYOUT__selected_hover = nuklear.nk_color.gRecordLayout.withName("selected_hover");
    public static final long OFFSET__selected_hover = 912;
    public static final java.lang.foreign.StructLayout LAYOUT__selected_text_normal = nuklear.nk_color.gRecordLayout.withName("selected_text_normal");
    public static final long OFFSET__selected_text_normal = 916;
    public static final java.lang.foreign.StructLayout LAYOUT__selected_text_hover = nuklear.nk_color.gRecordLayout.withName("selected_text_hover");
    ...
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__cursor_size = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("cursor_size");
    ...
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__row_padding = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("row_padding");
