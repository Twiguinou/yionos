...
public record nk_command_polygon_filled(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final long OFFSET$point_count = 20L;
    ...
    public static final long OFFSET$points = 22L;
    ...
    ).withName("nk_command_polygon_filled");
    ...
    public static nk_command_polygon_filled getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_polygon_filled(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
