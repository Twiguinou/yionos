...
public record nk_panel(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__offset_x = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("offset_x");
    public static final long OFFSET__offset_x = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__offset_y = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("offset_y");
    public static final long OFFSET__offset_y = 32;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__at_x = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("at_x");
    public static final long OFFSET__at_x = 40;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__at_y = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("at_y");
    public static final long OFFSET__at_y = 44;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__max_x = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("max_x");
    public static final long OFFSET__max_x = 48;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__footer_height = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("footer_height");
    public static final long OFFSET__footer_height = 52;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__header_height = java.lang.foreign.ValueLayout.JAVA_FLOAT.withName("header_height");
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__has_scrolling = java.lang.foreign.ValueLayout.JAVA_INT.withName("has_scrolling");
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__menu = nuklear.nk_menu_state.gRecordLayout.withName("menu");
    public static final long OFFSET__menu = 84;
    public static final java.lang.foreign.StructLayout LAYOUT__row = nuklear.nk_row_layout.gRecordLayout.withName("row");
    public static final long OFFSET__row = 112;
    public static final java.lang.foreign.StructLayout LAYOUT__chart = nuklear.nk_chart.gRecordLayout.withName("chart");
