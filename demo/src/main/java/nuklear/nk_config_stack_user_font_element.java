...
public record nk_config_stack_user_font_element(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT$old_value = java.lang.foreign.ValueLayout.ADDRESS;
    public static final long OFFSET$old_value = 8L;

    public static final java.lang.foreign.StructLayout gStructLayout = java.lang.foreign.MemoryLayout.structLayout(
            LAYOUT$address,
            LAYOUT$old_value
    ).withName("nk_config_stack_user_font_element");
    ...
    public static nk_config_stack_user_font_element getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_config_stack_user_font_element(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
    ...
    public java.lang.foreign.MemorySegment old_value() {return this._ptr.get(LAYOUT$old_value, OFFSET$old_value);}
    public void old_value(java.lang.foreign.MemorySegment value) {this._ptr.set(LAYOUT$old_value, OFFSET$old_value, value);}
