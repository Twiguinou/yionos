...
public record nk_config_stack_button_behavior_element(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__old_value = java.lang.foreign.ValueLayout.JAVA_INT.withName("old_value");
    ...
    ).withByteAlignment(8).withName("nk_config_stack_button_behavior_element");
    ...
    public static nk_config_stack_button_behavior_element getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new nk_config_stack_button_behavior_element(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, nk_config_stack_button_behavior_element value)
    {
