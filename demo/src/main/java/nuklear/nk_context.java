...
{
    public static final java.lang.foreign.StructLayout LAYOUT__input = nuklear.nk_input.gRecordLayout;
    public static final long OFFSET__input = 0;
    public static final java.lang.foreign.StructLayout LAYOUT__style = nuklear.nk_style.gRecordLayout;
    public static final long OFFSET__style = 360;
    public static final java.lang.foreign.StructLayout LAYOUT__memory = nuklear.nk_buffer.gRecordLayout;
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__last_widget_state = java.lang.foreign.ValueLayout.JAVA_INT;
    public static final long OFFSET__last_widget_state = 9624;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__button_behavior = java.lang.foreign.ValueLayout.JAVA_INT;
    public static final long OFFSET__button_behavior = 9628;
    public static final java.lang.foreign.StructLayout LAYOUT__stacks = nuklear.nk_configuration_stacks.gRecordLayout;
    public static final long OFFSET__stacks = 9632;
    public static final java.lang.foreign.ValueLayout.OfFloat LAYOUT__delta_time_seconds = java.lang.foreign.ValueLayout.JAVA_FLOAT;
    public static final long OFFSET__delta_time_seconds = 12504;
    public static final java.lang.foreign.StructLayout LAYOUT__draw_list = nuklear.nk_draw_list.gRecordLayout;
    public static final long OFFSET__draw_list = 12512;
    public static final java.lang.foreign.StructLayout LAYOUT__text_edit = nuklear.nk_text_edit.gRecordLayout;
    public static final long OFFSET__text_edit = 12752;
    public static final java.lang.foreign.StructLayout LAYOUT__overlay = nuklear.nk_command_buffer.gRecordLayout;
    public static final long OFFSET__overlay = 18136;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__build = java.lang.foreign.ValueLayout.JAVA_INT;
    public static final long OFFSET__build = 18200;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__use_pool = java.lang.foreign.ValueLayout.JAVA_INT;
    public static final long OFFSET__use_pool = 18204;
    public static final java.lang.foreign.StructLayout LAYOUT__pool = nuklear.nk_pool.gRecordLayout;
    public static final long OFFSET__pool = 18208;
    public static final java.lang.foreign.AddressLayout LAYOUT__begin = jpgen.NativeTypes.UNBOUNDED_POINTER;
    public static final long OFFSET__begin = 18280;
    public static final java.lang.foreign.AddressLayout LAYOUT__end = jpgen.NativeTypes.UNBOUNDED_POINTER;
    public static final long OFFSET__end = 18288;
    public static final java.lang.foreign.AddressLayout LAYOUT__active = jpgen.NativeTypes.UNBOUNDED_POINTER;
    public static final long OFFSET__active = 18296;
    public static final java.lang.foreign.AddressLayout LAYOUT__current = jpgen.NativeTypes.UNBOUNDED_POINTER;
