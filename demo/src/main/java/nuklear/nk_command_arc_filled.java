...
public record nk_command_arc_filled(java.lang.foreign.MemorySegment _ptr)
{
    ...
    ).withName("nk_command_arc_filled");
    ...
    public static nk_command_arc_filled getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_arc_filled(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
