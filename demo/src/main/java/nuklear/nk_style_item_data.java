...
public record nk_style_item_data(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__image = nuklear.nk_image.gRecordLayout;
    public static final java.lang.foreign.StructLayout LAYOUT__slice = nuklear.nk_nine_slice.gRecordLayout;
    ...
    public nuklear.nk_color color() {return new nuklear.nk_color(this._ptr.asSlice(0, LAYOUT__color));}
    public void color(java.util.function.Consumer<nuklear.nk_color> consumer) {consumer.accept(this.color());}
    public void color(nuklear.nk_color value) {java.lang.foreign.MemorySegment.copy(value._ptr(), 0, this._ptr, 0, LAYOUT__color.byteSize());}

    public nuklear.nk_image image() {return new nuklear.nk_image(this._ptr.asSlice(0, LAYOUT__image));}
    public void image(java.util.function.Consumer<nuklear.nk_image> consumer) {consumer.accept(this.image());}
    public void image(nuklear.nk_image value) {java.lang.foreign.MemorySegment.copy(value._ptr(), 0, this._ptr, 0, LAYOUT__image.byteSize());}

    public nuklear.nk_nine_slice slice() {return new nuklear.nk_nine_slice(this._ptr.asSlice(0, LAYOUT__slice));}
    public void slice(java.util.function.Consumer<nuklear.nk_nine_slice> consumer) {consumer.accept(this.slice());}
    public void slice(nuklear.nk_nine_slice value) {java.lang.foreign.MemorySegment.copy(value._ptr(), 0, this._ptr, 0, LAYOUT__slice.byteSize());}
}
