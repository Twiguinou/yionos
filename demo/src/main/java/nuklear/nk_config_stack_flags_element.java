...
public record nk_config_stack_flags_element(java.lang.foreign.MemorySegment _ptr)
{
    ...
    ).withName("nk_config_stack_flags_element");
    ...
    public static nk_config_stack_flags_element getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_config_stack_flags_element(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
