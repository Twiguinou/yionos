...
public record nk_style(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.SequenceLayout LAYOUT__cursors = java.lang.foreign.MemoryLayout.sequenceLayout(7, jpgen.NativeTypes.UNBOUNDED_POINTER).withName("cursors");
    public static final long OFFSET__cursors = 8;
    public static final java.lang.foreign.AddressLayout LAYOUT__cursor_active = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("cursor_active");
    public static final long OFFSET__cursor_active = 64;
    public static final java.lang.foreign.AddressLayout LAYOUT__cursor_last = jpgen.NativeTypes.UNBOUNDED_POINTER.withName("cursor_last");
    public static final long OFFSET__cursor_last = 72;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__cursor_visible = java.lang.foreign.ValueLayout.JAVA_INT.withName("cursor_visible");
    public static final long OFFSET__cursor_visible = 80;
    public static final java.lang.foreign.StructLayout LAYOUT__text = nuklear.nk_style_text.gRecordLayout.withName("text");
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__contextual_button = nuklear.nk_style_button.gRecordLayout.withName("contextual_button");
    public static final long OFFSET__contextual_button = 320;
    public static final java.lang.foreign.StructLayout LAYOUT__menu_button = nuklear.nk_style_button.gRecordLayout.withName("menu_button");
    public static final long OFFSET__menu_button = 536;
    public static final java.lang.foreign.StructLayout LAYOUT__option = nuklear.nk_style_toggle.gRecordLayout.withName("option");
    public static final long OFFSET__option = 752;
    public static final java.lang.foreign.StructLayout LAYOUT__checkbox = nuklear.nk_style_toggle.gRecordLayout.withName("checkbox");
    public static final long OFFSET__checkbox = 1040;
    public static final java.lang.foreign.StructLayout LAYOUT__selectable = nuklear.nk_style_selectable.gRecordLayout.withName("selectable");
    public static final long OFFSET__selectable = 1328;
    public static final java.lang.foreign.StructLayout LAYOUT__slider = nuklear.nk_style_slider.gRecordLayout.withName("slider");
    public static final long OFFSET__slider = 1664;
    public static final java.lang.foreign.StructLayout LAYOUT__progress = nuklear.nk_style_progress.gRecordLayout.withName("progress");
    public static final long OFFSET__progress = 2440;
    public static final java.lang.foreign.StructLayout LAYOUT__property = nuklear.nk_style_property.gRecordLayout.withName("property");
    ...
    public static final java.lang.foreign.StructLayout LAYOUT__chart = nuklear.nk_style_chart.gRecordLayout.withName("chart");
    public static final long OFFSET__chart = 5312;
    public static final java.lang.foreign.StructLayout LAYOUT__scrollh = nuklear.nk_style_scrollbar.gRecordLayout.withName("scrollh");
    public static final long OFFSET__scrollh = 5392;
    public static final java.lang.foreign.StructLayout LAYOUT__scrollv = nuklear.nk_style_scrollbar.gRecordLayout.withName("scrollv");
    public static final long OFFSET__scrollv = 6144;
    public static final java.lang.foreign.StructLayout LAYOUT__tab = nuklear.nk_style_tab.gRecordLayout.withName("tab");
    public static final long OFFSET__tab = 6896;
    public static final java.lang.foreign.StructLayout LAYOUT__combo = nuklear.nk_style_combo.gRecordLayout.withName("combo");
    public static final long OFFSET__combo = 7856;
    public static final java.lang.foreign.StructLayout LAYOUT__window = nuklear.nk_style_window.gRecordLayout.withName("window");
