...
public record nk_command_scissor(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.StructLayout gRecordLayout = java.lang.foreign.MemoryLayout.structLayout(
            ...
            LAYOUT__w,
            LAYOUT__h
    ).withByteAlignment(8).withName("nk_command_scissor");
    ...
    public static nk_command_scissor getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new nk_command_scissor(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, nk_command_scissor value)
    {
