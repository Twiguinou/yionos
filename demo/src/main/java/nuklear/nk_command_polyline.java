...
public record nk_command_polyline(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static nk_command_polyline getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_polyline(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
