...
public record nk_command_polyline(java.lang.foreign.MemorySegment _ptr)
{
    ...
    ).withByteAlignment(8).withName("nk_command_polyline");

    public nk_command_polyline(java.lang.foreign.SegmentAllocator allocator)
    {
        this(allocator.allocate(gRecordLayout));
    }

    public static nk_command_polyline getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new nk_command_polyline(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, nk_command_polyline value)
    {
