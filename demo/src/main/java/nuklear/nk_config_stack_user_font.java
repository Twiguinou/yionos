...
public record nk_config_stack_user_font(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.SequenceLayout LAYOUT__elements = java.lang.foreign.MemoryLayout.sequenceLayout(8, nuklear.nk_config_stack_user_font_element.gRecordLayout).withName("elements");
