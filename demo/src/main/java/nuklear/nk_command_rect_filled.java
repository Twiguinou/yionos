...
public record nk_command_rect_filled(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfShort LAYOUT__rounding = java.lang.foreign.ValueLayout.JAVA_SHORT.withName("rounding");
    public static final long OFFSET__rounding = 16;
    public static final java.lang.foreign.ValueLayout.OfShort LAYOUT__x = java.lang.foreign.ValueLayout.JAVA_SHORT.withName("x");
    public static final long OFFSET__x = 18;
    public static final java.lang.foreign.ValueLayout.OfShort LAYOUT__y = java.lang.foreign.ValueLayout.JAVA_SHORT.withName("y");
    public static final long OFFSET__y = 20;
    ...
    ).withByteAlignment(8).withName("nk_command_rect_filled");

    public nk_command_rect_filled(java.lang.foreign.SegmentAllocator allocator)
    {
        this(allocator.allocate(gRecordLayout));
    }

    public static nk_command_rect_filled getAtIndex(java.lang.foreign.MemorySegment buffer, int index)
    {
        return new nk_command_rect_filled(buffer.asSlice(index * gRecordLayout.byteSize(), gRecordLayout));
    }

    public static void setAtIndex(java.lang.foreign.MemorySegment buffer, int index, nk_command_rect_filled value)
    {
    ...
    public short rounding() {return this._ptr.get(LAYOUT__rounding, OFFSET__rounding);}
    public void rounding(short value) {this._ptr.set(LAYOUT__rounding, OFFSET__rounding, value);}
