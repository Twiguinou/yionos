...
public record nk_command_rect_filled(java.lang.foreign.MemorySegment _ptr)
{
    ...
    ).withName("nk_command_rect_filled");
    ...
    public static nk_command_rect_filled getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_rect_filled(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
