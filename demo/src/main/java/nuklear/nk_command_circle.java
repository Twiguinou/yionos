...
public record nk_command_circle(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static nk_command_circle getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_circle(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
