...
public record nk_command_line(java.lang.foreign.MemorySegment _ptr)
{
    ...
    public static nk_command_line getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new nk_command_line(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
